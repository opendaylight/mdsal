...
public final class NamespaceHandlerUtils {
    ...
    public static ServiceRegistration<NamespaceHandler> registerNamespaceHandler(final BundleContext context,
            final String namespace, final NamespaceHandler handler) {
        final Dictionary<String, Object> props = new Hashtable<>();
        props.put("osgi.service.blueprint.namespace", requireNonNull(namespace));

        return context.registerService(NamespaceHandler.class, requireNonNull(handler), props);
    }
}
