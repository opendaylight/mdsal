...
public final class OpendaylightNamespaceHandler implements NamespaceHandler {
    ...
    public OpendaylightNamespaceHandler(final BlueprintContainerRestartService restartService) {
    ...
    private Metadata parseRpcService(final Element element, final ParserContext context) {
        ComponentFactoryMetadata metadata = new RpcServiceMetadata(getId(context, element), restartService,
                element.getAttribute(INTERFACE));
    ...
    private Metadata parseClusteredAppConfig(final Element element, final ParserContext context) {
        ...
        return new DataStoreAppConfigMetadata(getId(context, element), restartService, element.getAttribute(
