...
final class Constants {
    ...
    /**
     * Subscribe request acknowledgement. This is the only valid initial message in the source->sink direction. It has
     * an empty payload. This message has to be followed by {@link #MSG_EMPTY_DATA} or {@link #MSG_DTC_CHUNK}.
     */
    static final byte MSG_SUBSCRIBE_ACK = 2;
    /**
     * Initial data indicating non-presence of the subscribed path.
     */
    static final byte MSG_EMPTY_DATA    = 3;
    /**
    ...
    static final ByteBuf SUBSCRIBE_ACK = Unpooled.wrappedBuffer(new byte[] { MSG_SUBSCRIBE_ACK });
