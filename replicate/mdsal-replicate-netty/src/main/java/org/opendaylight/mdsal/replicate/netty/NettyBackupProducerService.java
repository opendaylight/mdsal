...
import org.opendaylight.mdsal.replicate.common.AbstractBackupProducerService;
            ...
            channelActiveFuture = ctx.channel().eventLoop().scheduleWithFixedDelay(() -> {
                while (!candidateQueue.isEmpty()) {
                    ...
                    try {
                        ...
                        log.error("Could not Send DataTreeCandidate: {}", candidate.getRootNode().getIdentifier(), e);
