...
public final class DTCSerializer {
    ...
    public static byte[] serializeDTC(final DataTreeCandidate candidate) throws DTCSerializationException {
    ...
    public static DataTreeCandidate deserializeDTC(final byte[] candidateData) throws DTCSerializationException {
