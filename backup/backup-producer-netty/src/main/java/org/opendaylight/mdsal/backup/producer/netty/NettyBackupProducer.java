...
/**
 * Bean producing the {@link NettyBackupProducerService} and registering it as a ClusterSingleton.
 */

public class NettyBackupProducer {
    ...
    public NettyBackupProducer(final DOMDataBroker dataBroker,
            final ClusterSingletonServiceProvider singletonServiceProvider) {
        this.domDataBroker = dataBroker;
        this.clusterSingletonServiceProvider = singletonServiceProvider;
        this.backupProducerService = new NettyBackupProducerService(domDataBroker);
    }
