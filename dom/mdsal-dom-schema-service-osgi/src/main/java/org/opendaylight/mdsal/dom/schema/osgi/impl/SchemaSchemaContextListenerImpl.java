...
public final class SchemaSchemaContextListenerImpl implements SchemaContextListener {
    static final String FACTORY_NAME =
            "org.opendaylight.mdsal.dom.schema.service.osgi.impl.SchemaSchemaContextListener";

    @VisibleForTesting
    static final String DELEGATE = "org.opendaylight.mdsal.dom.schema.service.runtime.osgi.SchemaSchemaContextListener";
