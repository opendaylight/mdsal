...
import org.opendaylight.mdsal.dom.testkit.spi.AbstractDOMServiceTestKit.ListenerClassifier;
...
final class CapturingDOMDataBrokerImpl<D extends DOMDataBroker> extends ForwardingDOMDataBroker
    ...
    CapturingDOMDataBrokerImpl(final D delegate, final ListenerClassifier classifier) {
