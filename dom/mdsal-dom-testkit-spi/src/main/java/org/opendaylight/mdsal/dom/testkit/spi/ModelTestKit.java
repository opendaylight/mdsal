...
/**
 * A simple testkit which maintains a lazily-populated {@link EffectiveModelContext} based either on an explicit list of
 * {@link YangModuleInfo} instances or based on all instances discovered through Thread Context Class Loader at
 * instantiation time.
 */
@Beta
public class ModelTestKit {
    ...
    public ModelTestKit(final Set<YangModuleInfo> moduleInfos) {
