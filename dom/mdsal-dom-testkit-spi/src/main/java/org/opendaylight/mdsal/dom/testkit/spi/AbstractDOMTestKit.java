...
@Beta
public abstract class AbstractDOMTestKit<D extends DOMDataBroker> extends ModelTestKit
    ...
    public static final @NonNull ImmutableSet<LogicalDatastoreType> BOTH_DATASTORES = ImmutableSet.of(
    ...
    protected AbstractDOMTestKit() {
        datastoreTypes = BOTH_DATASTORES;
    ...
    public abstract DOMNotificationPublishService domNotificationPublishService();

    public abstract DOMNotificationService domNotificationService();
