...
public abstract class AbstractDOMTestKit<D extends DOMDataBroker> extends EffectiveModelContextTestKit
    ...
    @NonNullByDefault
    public abstract static class ListenerEvent {
        final DOMDataTreeChangeListener listener;
        final Object marker;

        ListenerEvent(final DOMDataTreeChangeListener listener, final Object marker) {
    ...
    public static final @NonNull ListenerClassifier PASS_CLASSIFIER = (treeId, listener) -> ListenerPolicy.PASS;
    ...
    protected AbstractDOMTestKit(final Set<YangModuleInfo> moduleInfos,
            final Set<LogicalDatastoreType> datastoreTypes, final ListenerClassifier classifier) {
        super(moduleInfos);
        this.datastoreTypes = ImmutableSet.copyOf(datastoreTypes);
        this.classifier = requireNonNull(classifier);
    }
