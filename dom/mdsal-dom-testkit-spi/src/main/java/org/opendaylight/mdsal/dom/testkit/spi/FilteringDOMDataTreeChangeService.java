...
import org.opendaylight.mdsal.dom.testkit.spi.AbstractDOMTestKit.ListenerClassifier;
...
final class FilteringDOMDataTreeChangeService implements DOMDataTreeChangeService {
    @GuardedBy("this")
    private final Deque<AbstractDOMTestKit.ListenerEvent> events = new ArrayDeque<>();
    ...
    synchronized void addEvent(final AbstractDOMTestKit.ListenerEvent event) {
        events.add(event);
    }
    ...
    void fireCapturedEvents(final EventPredicate predicate) {
        ...
        final List<AbstractDOMTestKit.ListenerEvent> satb;
        synchronized (this) {
        ...
        final Deque<AbstractDOMTestKit.ListenerEvent> unaccepted = new ArrayDeque<>();
        for (AbstractDOMTestKit.ListenerEvent event : satb) {
    ...
    @NonNullByDefault
    private static final class InitialData extends AbstractDOMTestKit.ListenerEvent {
    ...
    @NonNullByDefault
    private static final class DataTreeChanged extends AbstractDOMTestKit.ListenerEvent {
