...
import org.opendaylight.mdsal.dom.testkit.spi.AbstractDOMServiceTestKit;
...
public class DOMServiceTestKit extends AbstractDOMServiceTestKit<SerializedDOMDataBroker> {
    ...
    public DOMServiceTestKit(final Set<LogicalDatastoreType> datastoreTypes, final ListenerClassifier classifier) {
    ...
    public DOMServiceTestKit(final Set<YangModuleInfo> moduleInfos, final Set<LogicalDatastoreType> datastoreTypes,
