...
abstract class AbstractDOMRoutingTable<I, D, M, L extends EventListener,
    ...
    private void add(final M implementation, final Set<I> oprsToAdd, final Builder<SchemaPath, E> tableInputBuilder) {
    ...
    AbstractDOMRoutingTable<I, D, M, L, E> addAll(final Map<I, M> map) {
        ...
        final Builder<SchemaPath, E> tableInputBuilder = ImmutableMap.builder();
    ...
    private void remove(final M implementation, final Set<I> oprsToRemove,
                        final Builder<SchemaPath, E> tableInputBuilder) {
        final ListMultimap<SchemaPath, D> toRemove = decomposeIdentifiers(oprsToRemove);
