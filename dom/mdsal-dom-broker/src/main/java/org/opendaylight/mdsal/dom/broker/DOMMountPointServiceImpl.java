...
import org.opendaylight.mdsal.dom.api.DOMMountListener;
...
public class DOMMountPointServiceImpl implements DOMMountPointService {
    ...
    private final ListenerRegistry<DOMMountListener> listeners = ListenerRegistry.create();
    ...
    public void notifyMountCreated(final YangInstanceIdentifier identifier) {
        for (final ListenerRegistration<DOMMountListener> listener : listeners
                .getListeners()) {
    ...
    @Override
    public ListenerRegistration<DOMMountListener> registerProvisionListener(
            final DOMMountListener listener) {
