...
public class SchemaServiceActivatorTest {
    ...
    public void basicTest() throws Exception {
        final BundleContext bundleContext = mock(BundleContext.class, CALLS_REAL_METHODS);
        ...
        final OsgiBundleScanningSchemaService osgiBundle = mock(OsgiBundleScanningSchemaService.class, CALLS_REAL_METHODS);
