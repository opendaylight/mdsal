...
public class ShardedDOMDataTreeProducerMultiShardTest {
    ...
    public void testSingleShardListener() throws Exception {
        ...
        writeCrossShardContainer(producer);

        verify(mockedDataTreeListener, timeout(100)).onDataTreeChanged(captorForChanges.capture(), captorForSubtrees.capture());
    ...
    public void testMultipleShards() throws Exception {
        ...
        verify(mockedDataTreeListener, timeout(100).times(2)).onDataTreeChanged(captorForChanges.capture(), captorForSubtrees.capture());
    ...
    private void writeCrossShardContainer(final DOMDataTreeShardProducer producer) throws Exception{
        final DOMDataTreeShardWriteTransaction transaction = producer.createTransaction();
        final DOMDataTreeWriteCursor cursor = transaction.createCursor(ROOT_ID);
