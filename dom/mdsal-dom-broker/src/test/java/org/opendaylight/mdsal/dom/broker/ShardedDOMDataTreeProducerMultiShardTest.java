...
public class ShardedDOMDataTreeProducerMultiShardTest {
    ...
    public void testMultipleCursorsFromOneTx() throws Exception {
        ...
        dataTreeService.registerListener(mockedDataTreeListener,
                Collections.singletonList(INNER_CONTAINER_ID), true, Collections.emptyList());
        ...
        verify(mockedDataTreeListener, timeout(1000).times(2)).onDataTreeChanged(captorForChanges.capture(),
    ...
    public void testSingleShardListener() throws Exception {
        ...
        final ContainerNode dataAfter = (ContainerNode)
                capturedValue.iterator().next().getRootNode().getDataAfter().get();
        ...
        assertEquals(crossShardContainer.getChild(
                TestModel.INNER_CONTAINER_PATH.getLastPathArgument()).get(), capturedSubtrees.get(INNER_CONTAINER_ID));
    ...
    public void testMultipleShards() throws Exception {
        ...
        final InMemoryDOMDataTreeShard innerShard =
                InMemoryDOMDataTreeShard.create(INNER_CONTAINER_ID, executor, 1, 1);
        innerShard.onGlobalContextUpdated(schemaContext);
        final DOMDataTreeProducer shardRegProducer = dataTreeService.createProducer(
        ...
        dataTreeService.registerListener(mockedDataTreeListener,
                Collections.singletonList(TEST_ID), true, Collections.emptyList());
        ...
        verify(mockedDataTreeListener, timeout(1000).times(4)).onDataTreeChanged(captorForChanges.capture(),
                captorForSubtrees.capture());
    ...
    public void testMockedSubshards() throws Exception {
        ...
        final ContainerNode lowerShardContainer = ImmutableContainerNodeBuilder.create()
                ...
                .withChild(ImmutableLeafNodeBuilder.create().withNodeIdentifier(new NodeIdentifier(
                        TestModel.ANOTHER_SHARD_VALUE)).build())
                .build();
