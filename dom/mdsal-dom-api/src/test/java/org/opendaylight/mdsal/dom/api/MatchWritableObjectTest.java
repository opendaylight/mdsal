...
public class MatchWritableObjectTest {
    ...
    public void testMatchAll() throws Exception {
        ...
        final var matcher10 = DOMQueryPredicate.Match.valueEquals("text".getBytes(StandardCharsets.UTF_8));

        final var matchAll = matcher.and(matcher1).and(matcher2).and(matcher3).and(matcher4).and(matcher5).and(matcher6)
            .and(matcher7).and(matcher8).and(matcher9).and(matcher10);
        ...
        final var match = "allOf(exists(), gt(5), gte(5), eq(true), lte(127), lte((urn:test?revision=2017-01-01)cont),"
            + " eq(empty), lte(-92233720368547758.08), lte(0), gt(true), eq([B@5bda8e08))";
