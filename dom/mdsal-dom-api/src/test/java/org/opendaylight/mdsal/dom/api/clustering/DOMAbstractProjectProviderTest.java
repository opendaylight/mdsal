...
/**
 * Testing {@link DOMAbstractProjectProvider} implementation
 */
public class DOMAbstractProjectProviderTest {
    ...
    @Mock
    private DOMEntityOwnershipCandidateRegistration mockEntityReg;
    @Mock
    private DOMEntityOwnershipCandidateRegistration mockDoubleEntityReg;
    @Mock
    ...
    private final DOMEntity entity = new DOMEntity(PROJECT_ENTITY, TestClusterProjectProvider.class.getCanonicalName());
    private final DOMEntity doubleEntity = new DOMEntity(DOUBLE_CANDIDATE_PROJECT_ENTITY,
    ...
    public void setup() throws Exception {
        ...
        doReturn(mockEosEntityListReg).when(mockEos).registerListener(eq(PROJECT_ENTITY),
                any(DOMAbstractProjectProvider.class));
    ...
    public void initializationClusterProjectProviderTest() throws Exception {
        testProjectProvider.initializationClusterProjectProvider();
     ...
     */
    class TestClusterProjectProvider extends DOMAbstractProjectProvider {
        ...
        @Override
        protected ListenableFuture<Void> suspendProject() {
