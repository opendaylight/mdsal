 ...
 * {@link PostCanCommitStep#preCommit()} and {@link PostPreCommitStep#commit()} callback was
 * invoked.
 *
 *
...
public interface DOMDataTreeCommitCohort {
     ...
     * {@link PostCanCommitStep}, which will be used to invoke {@link PostCanCommitStep#preCommit()}
     * or {@link PostCanCommitStep#abort()} based on accepting data by data broker and or other
     * commit cohorts.
     *
     ...
     * @param tree Data Tree candidate to be validated and committed.
