...
public interface DOMDataTreeReadWriteTransaction extends DOMDataTreeWriteTransaction, DOMDataTreeReadTransaction {
    /**
     * This method is an API design mistake. Users are should not use it and use {@link #cancel()} instead.
     * Implementations should not override it and rely instead of its default implementation, which calls
     * {@link #cancel()}.
     *
