...
public interface DOMInstanceNotificationPublishService extends
     ...
     * {@link #putNotification(DOMDataTreeIdentifier, DOMNotification)}, this method is guaranteed not to block if the
     ...
     * The type of the object resulting from the future is not defined and implementations may use
     * it to convey additional information related to the publishing process. Unlike
     * {@link #putNotification(DOMDataTreeIdentifier, DOMNotification)}, this method is guaranteed to block more than
