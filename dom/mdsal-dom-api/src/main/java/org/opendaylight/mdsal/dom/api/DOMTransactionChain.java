...
public interface DOMTransactionChain extends Registration, DOMTransactionFactory {
     ...
     *
     * <p>The previous write transaction has to be either SUBMITTED ({@link DOMDataTreeWriteTransaction#commit commit}
     * was invoked) or CANCELLED ({@link #close close} was invoked).
     *
     ...
     *
     * <p>Committing this write-only transaction using {@link DOMDataTreeWriteTransaction#commit commit} will commit
     ...
     * transaction chain after creation of the previous transaction is not visible.
     *
     * <p>Committing this read-write transaction using {@link DOMDataTreeReadWriteTransaction#commit commit} will commit
     * the state changes in this transaction to be visible to any subsequent transaction in this chain and also to any
     * transaction outside this chain.
     *
     * @return New transaction in the chain.
