...
public interface DOMXPathCallback extends BiConsumer<Optional<? extends XPathResult<?>>, XPathException> {
    /**
     * Process the result of XPath evaluation. One of the arguments is guaranteed to be non-null, indicating whether
     * the evaluation was successful or not.
     */
    @Override
    void accept(@Nullable Optional<? extends XPathResult<?>> success, @Nullable XPathException failure);
