...
/**
 * The real host of the {@link PingPongTransactionChain} implementation. This class is factored out to allow testing
 * the various internal code paths.
 */
@VisibleForTesting
abstract class AbstractPingPongTransactionChain implements DOMTransactionChain {
     ...
     */
    private synchronized void cancelTransaction(final PingPongTransaction tx,
