...
public final class DOMDataTreeListenerAggregator
    ...
    private DOMDataTreeListenerAggregator(final int sizeHint, final boolean allowRxMerges) {
        super(sizeHint);
    ...
    private DOMDataTreeListener createListener() {
    ...
    private <L extends DOMDataTreeListener> ListenerRegistration<L> start(final L listener,
