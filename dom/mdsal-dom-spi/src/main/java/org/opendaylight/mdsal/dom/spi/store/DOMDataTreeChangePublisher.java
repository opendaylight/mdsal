 ...
 */
@Beta
public interface DOMDataTreeChangePublisher {
    /**
     ...
     *
     * @param trees
     *            Data tree identifier of subtrees which should be watched for
     *            changes. Duplicate items are ignored.
     * @param listener
     ...
     */
    @Nonnull
    <L extends DOMDataTreeChangeListener> ListenerRegistration<L> registerTreeChangeListener(@Nonnull L listener,
            @Nonnull Collection<YangInstanceIdentifier> trees);
}
