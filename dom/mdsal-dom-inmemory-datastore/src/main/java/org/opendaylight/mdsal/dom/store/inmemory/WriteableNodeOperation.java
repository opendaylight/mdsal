...
abstract class WriteableNodeOperation implements WriteCursorStrategy {
    ...
    WriteableNodeOperation(WriteableModificationNode node, DOMDataTreeWriteCursor cursor) {
        this.node = node;
        this.cursor = cursor;
    }
    ...
    @Override
    public void delete(PathArgument arg) {
        cursor.delete(arg);
    ...
    @Override
    public void merge(PathArgument arg, NormalizedNode<?, ?> data) {
        WriteableModificationNode potentialChild = node.getChild(arg);
        if (potentialChild == null) {
    ...
    @Override
    public void write(PathArgument arg, NormalizedNode<?, ?> data) {
        WriteableModificationNode potentialChild = node.getChild(arg);
        if (potentialChild == null) {
    ...
    public WriteCursorStrategy enter(PathArgument arg) {
        ...
        return new WriteCursorDelegatingStrategy(cursor);
    }
