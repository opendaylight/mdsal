...
class InMemoryDOMDataTreeShardProducer implements DOMDataTreeShardProducer {
    ...
    private InMemoryDOMDataTreeShard parentShard;
    private Collection<DOMDataTreeIdentifier> prefixes;
    ...
    InMemoryDOMDataTreeShardProducer(InMemoryDOMDataTreeShard parentShard,
            Collection<DOMDataTreeIdentifier> prefixes) {
