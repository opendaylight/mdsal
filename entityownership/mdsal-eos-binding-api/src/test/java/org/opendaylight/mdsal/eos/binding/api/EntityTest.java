...
public class EntityTest {
    ...
    public void testHashCode() {
        final Entity entity1 = new Entity(ENTITY_TYPE1, ID1);
    ...
    public void testSerialization() {
        final Entity entity = new Entity(ENTITY_TYPE1, ID1);

        final Entity clone = SerializationUtils.clone(entity);
    ...
    public void testEntityNameConstructor() {
        final Entity entity = new Entity(ENTITY_TYPE1, "foo");

        final Identifier<org.opendaylight.yang.gen.v1.urn.opendaylight.params.xml.ns.yang.
