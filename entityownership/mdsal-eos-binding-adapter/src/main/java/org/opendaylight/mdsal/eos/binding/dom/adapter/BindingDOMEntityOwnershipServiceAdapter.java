...
public class BindingDOMEntityOwnershipServiceAdapter implements EntityOwnershipService, AutoCloseable {
    ...
    public BindingDOMEntityOwnershipServiceAdapter(@Nonnull final DOMEntityOwnershipService domService,
            @Nonnull final BindingToNormalizedNodeCodec conversionCodec) {
    ...
    private DOMEntity toDOMEntity(final Entity entity) {
