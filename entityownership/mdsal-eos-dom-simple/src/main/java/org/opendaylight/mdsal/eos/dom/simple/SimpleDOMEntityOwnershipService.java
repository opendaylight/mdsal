...
public final class SimpleDOMEntityOwnershipService implements DOMEntityOwnershipService {
    ...
    @Override
    public synchronized DOMEntityOwnershipCandidateRegistration registerCandidate(final DOMEntity entity)
        ...
        notifyListeners(entity, EntityOwnershipChangeState.LOCAL_OWNERSHIP_GRANTED);
    ...
    public DOMEntityOwnershipListenerRegistration registerListener(final String entityType,
        ...
        synchronized (listeners) {
            ...
            for (DOMEntity entity : owned) {
                notifyListener(listener, new DOMEntityOwnershipChange(entity,
    ...
    private void removeEntity(final DOMEntity entity) {
        ...
        notifyListeners(entity, EntityOwnershipChangeState.LOCAL_OWNERSHIP_LOST_NO_OWNER);
    }
    ...
    private void notifyListeners(final DOMEntity entity, final EntityOwnershipChangeState state) {
        ...
        synchronized (listeners) {
            for (DOMEntityOwnershipListener listener : listeners.get(entity.getType())) {
