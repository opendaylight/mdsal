...
final class AnnotationTypeBuilderImpl extends AbstractBaseType implements AnnotationTypeBuilder {
    ...
    AnnotationTypeBuilderImpl(final String pkgName, final String strName) {
        super(pkgName, strName, true, null);
        this.packageName = pkgName;
        this.name = strName;
    }

    @Override
    public AnnotationTypeBuilder addAnnotation(final String pkgName, final String strName) {
        if (pkgName != null && strName != null) {
            final AnnotationTypeBuilder builder = new AnnotationTypeBuilderImpl(pkgName, strName);
