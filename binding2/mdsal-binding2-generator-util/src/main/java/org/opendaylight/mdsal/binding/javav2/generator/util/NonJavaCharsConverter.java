 ...
 * <li>
 * <ul>
 * <li>parts of package name are seprated by dots</li>
 ...
 * <li>org.example*example - org.exampleaserisksexample</li>
...
public final class NonJavaCharsConverter {
    ...
    public static String normalizeFullPackageName(final String fullPackageName) {
        ...
        for (int i = 0; i < packageNameParts.length; i++) {
            sb.append(NonJavaCharsConverter.normalizePackageName(packageNameParts[i]));
    ...
    public static String normalizePackageName(final String packageNamePart) {
        // if part of package name consist from java or windows reserved word, return ti with
