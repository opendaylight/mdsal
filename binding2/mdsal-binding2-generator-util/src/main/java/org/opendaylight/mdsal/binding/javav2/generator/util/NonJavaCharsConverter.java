...
public final class NonJavaCharsConverter {
    ...
    public static String convertIdentifier(final String identifier, final JavaIdentifier javaIdentifier) {
        ...
        // check and convert another chars in identifier, if there is non-java char
        ...
        // last step is fixing cases in converted or non-converted identifier
    ...
    /**
     * For special java type, there are unwanted chars in original converted
     * identifier. This method remove them and return this converted identifier
     * with fixed cases
     *
     * @param convertedIdentifier
     *            - original converted identifier
     * @return converted identifier without additional chars and with fix cases
     */
