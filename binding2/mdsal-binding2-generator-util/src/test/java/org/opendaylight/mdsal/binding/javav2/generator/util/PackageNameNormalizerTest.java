...
public class PackageNameNormalizerTest {
    ...
    public void resrvedKeyWordsTest() {
        for (final String reservedKeyword : BindingMapping.JAVA_RESERVED_WORDS) {
            final String packageNameNormalizer = PackageNameNormalizer.packageNameNormalizer(reservedKeyword);
    ...
    public void digitAtStartTest() {
        for (int i = 0; i < 10; i++) {
            ...
            final String packageNameNormalizer = PackageNameNormalizer.packageNameNormalizer(str_i);
    ...
    public void dashTest() {
        ...
        final String packageNameNormalizer = PackageNameNormalizer.packageNameNormalizer(test);
    ...
    private void testNonJavaChar(final String tested, final Object expected) {
        final String packageNameNormalizer = PackageNameNormalizer.packageNameNormalizer(tested);
        assertEquals(expected, packageNameNormalizer);
    }
