...
public class BindingReflections {
    ...
    private static final String ROOT_PACKAGE_PATTERN_STRING = new StringBuilder('(').append(PACKAGE_PREFIX)
            .append(".[a-z0-9_\\.]*\\.rev[0-9][0-9][0-1][0-9][0-3][0-9])").toString();
     ...
     */
    public static Class<?> findHierarchicalParent(final Class<? extends TreeChildNode<?, ?>> childClass) {
