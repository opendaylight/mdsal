...
public class UnionBuilderRenderer extends ClassRenderer {
    ...
    protected String body() {
        ...
        for (MethodSignature methodSignature : getGenTO().getMethodDefinitions()) {
        ...
        return unionBuilderTemplate.render(getGenTO(), getType().getName(), importedNames, generatedParameters).body();
    }
}