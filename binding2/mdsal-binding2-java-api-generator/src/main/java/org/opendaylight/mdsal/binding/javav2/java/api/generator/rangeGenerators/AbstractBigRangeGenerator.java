...
/**
 * Abstract base for generators which require instantiation of boundary values to check.
 * These are implemented by generating an array constant within the class, which contains
 * {@link Range} instances, which hold pre-instantiated boundary values.
 *
