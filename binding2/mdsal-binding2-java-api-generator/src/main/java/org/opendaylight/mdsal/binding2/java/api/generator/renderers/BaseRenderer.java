...
public abstract class BaseRenderer {
     ...
     */
    protected String asArgumentsDeclaration(Iterable<GeneratedProperty> parameters) {
     ...
     */
    protected String emitConstant(Constant constant) {
     ...
     */
    protected String getterMethod(GeneratedProperty field) {
