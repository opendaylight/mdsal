...
public abstract class BaseRenderer {
    ...
    protected String getFromImportMap(String typeName) {
    ...
    private StringBuilder addActualTypeParameters(final StringBuilder sb, final Type type, final GeneratedType parentGenType,
        ...
        if (type instanceof ParameterizedType) {
            ...
            sb.append('<');
            sb.append(getParameters(parentGenType, pTypes, imports));
            sb.append('>');
        }
        return sb;
    }
    ...
    private String getParameters(final GeneratedType parentGenType, final Type[] pTypes, final Map<String, String> availableImports) {
        ...
        for (int i = 0; i < pTypes.length; i++) {
            ...
            if (t.equals(Types.voidType())) {
                ...
                sb.append(wildcardParam).append(getExplicitType(parentGenType, t, availableImports)).append(separator);
            }
        }
        return sb.toString();
    }
