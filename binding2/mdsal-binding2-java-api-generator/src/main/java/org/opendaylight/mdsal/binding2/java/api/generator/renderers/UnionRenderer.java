...
public class UnionRenderer extends ClassRenderer {
    ...
    protected String generateConstructors() {
        ...
        for (GeneratedProperty parentProperty : parentProperties) {
    ...
    protected String getterMethod(final GeneratedProperty field) {
        ...
        final Function<GeneratedProperty, Boolean> tempFunction = (GeneratedProperty p) -> {
            ...
            boolean equals = "value".equals(name);
            return Boolean.valueOf((!equals));
        };
        Iterable<GeneratedProperty> filtered = Iterables.<GeneratedProperty>filter(this.finalProperties, (Predicate<?
                super GeneratedProperty>) tempFunction);
