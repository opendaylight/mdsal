...
public class UnionBuilderRendererTest {
    ...
    @Test
    public void unionBuilderRendererTest() {
        //        TO DO implement tests
        String unionBuilderRenderer = new UnionBuilderRenderer(genType).generateTemplate();
        System.out.println(unionBuilderRenderer);
    }
}