...
abstract class OperationMethodInvoker {
    ...
    protected abstract Future<RpcResult<?>> invokeOn(Object impl, Instantiable<?> input);

    protected static OperationMethodInvoker from(final Method method) {
        final Optional<Class<? extends Instantiable<?>>> input = BindingReflections.resolveRpcInputClass(method);
        try {
