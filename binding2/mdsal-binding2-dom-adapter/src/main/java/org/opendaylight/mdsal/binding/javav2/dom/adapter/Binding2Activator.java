...
public class Binding2Activator implements BundleActivator {
    ...
    private static final Logger LOG = LoggerFactory.getLogger(Binding2Activator.class);
    ...
    public void start(final BundleContext context) {
        LOG.info("Start Binding2Activator.");
        ...
        if (schemaService != null) {
            ...
            LOG.error("Missing DOMSchemaSerivce service.");
        }
    }
