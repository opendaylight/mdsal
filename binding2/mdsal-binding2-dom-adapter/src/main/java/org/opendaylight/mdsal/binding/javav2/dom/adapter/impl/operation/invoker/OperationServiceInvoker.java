 ...
 * {@link #invoke(Object, QName, Instantiable)} method.
 */
@Beta
public abstract class OperationServiceInvoker {
     ...
     *
     */
    public static OperationServiceInvoker from(final Class<?> type) {
     ...
     */
    public abstract Future<RpcResult<?>> invoke(@Nonnull Object impl, @Nonnull QName operationName,
