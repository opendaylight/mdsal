 ...
 */
@Beta
public class BindingDataTreeChangeListenerRegistration<L extends DataTreeListener>
        extends AbstractListenerRegistration<L> {

    private final ListenerRegistration<?> domReg;

    public BindingDataTreeChangeListenerRegistration(final L listener, final ListenerRegistration<?> domReg) {
        super(listener);
