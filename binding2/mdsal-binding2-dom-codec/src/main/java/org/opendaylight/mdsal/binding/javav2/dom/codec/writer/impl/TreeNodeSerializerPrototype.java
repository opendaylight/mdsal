 ...
 */
package org.opendaylight.mdsal.binding.javav2.dom.codec.writer.impl;
...
/**
 * Prototype of a TreeNodeSerializerImplementation. This is a template class,
 * which the strem writer generator uses to instantiate
 * {@link TreeNodeSerializerImplementation} on a per-type basis. During that
 * time, the
 * {@link #serialize(TreeNodeSerializerRegistry, TreeNode, BindingStreamEventWriter)}
