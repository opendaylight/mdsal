...
public interface BindingTreeNodeCodec<T extends TreeNode> extends BindingNormalizedNodeCodec<T> {
     ...
     */
    @Nonnull
    BindingTreeNodeCodec<?> bindingPathArgumentChild(@Nonnull InstanceIdentifier<? extends TreeNode> arg,
     ...
     */
    @Nullable
    YangInstanceIdentifier.PathArgument serializePathArgument(@Nullable InstanceIdentifier<? extends TreeNode> arg);
     ...
     */
    @Nullable
    InstanceIdentifier<? extends TreeNode> deserializePathArgument(@Nullable YangInstanceIdentifier.PathArgument arg);
