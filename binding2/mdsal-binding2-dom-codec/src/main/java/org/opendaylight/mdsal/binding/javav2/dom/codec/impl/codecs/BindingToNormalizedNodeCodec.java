...
public final class BindingToNormalizedNodeCodec
     ...
     * @returns DOM Instance Identifie
     */
    ...
    /**
     * Resolve method with path of specific operation as binding object.
     *
     * @param key
     *            - operation as binding object
     * @return map of method with path of specific operation
     */
    public ImmutableBiMap<Method, SchemaPath> getOperationMethodToSchemaPath(final Class<?> key) {
        ...
        try {
            ...
            throw new IllegalStateException(
                    "Operation defined in model does not have representation in generated class.", e);
        }
        return ret.build();
    }

    /**
     * Resolve method with definition of specific operation as binding object.
     *
     * @param key
     *            - operation as binding object
     * @return map of method with definition of specific operation
     */
    public ImmutableBiMap<Method, OperationDefinition> getOperationMethodToSchema(final Class<?> key) {
        final Module module = getModuleBlocking(key);
    ...
    // }
    //
    // protected DataTreeIdentifier toDOMDataTreeIdentifier(final DataTreeIdentifier<?> path) {
