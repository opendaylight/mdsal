...
import org.opendaylight.mdsal.binding.javav2.dom.codec.impl.codecs.OperationInputCodec;
...
import org.opendaylight.mdsal.binding.javav2.generator.impl.ModuleInfoBackedContext;
...
public class BindingNormalizedNodeCodecRegistry implements TreeNodeSerializerRegistry, BindingTreeCodecFactory,
    ...
    @SuppressWarnings("unchecked")
    @Override
    public ContainerNode toNormalizedNodeOperationData(final Instantiable<?> data) {
        final NormalizedNodeResult result = new NormalizedNodeResult();
        // We create DOM stream writer which produces normalized nodes
        final NormalizedNodeStreamWriter domWriter = ImmutableNormalizedNodeStreamWriter.from(result);
        @SuppressWarnings("rawtypes")
    ...
    @Override
    public Entry<InstanceIdentifier<?>, TreeNode> fromNormalizedNode(final YangInstanceIdentifier path,
    ...
    @Override
    public TreeNode fromNormalizedNodeOperationData(final SchemaPath path, final ContainerNode data) {
    ...
    public Entry<YangInstanceIdentifier, BindingStreamEventWriter>
            newWriterAndIdentifier(final InstanceIdentifier<?> path, final NormalizedNodeStreamWriter domWriter) {
