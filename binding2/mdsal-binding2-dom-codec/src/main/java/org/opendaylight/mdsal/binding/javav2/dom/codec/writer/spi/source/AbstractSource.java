...
abstract class AbstractSource {
    ...
    private final Set<StaticConstant> staticConstants = new HashSet<>();
    ...
    public final <T> void staticConstant(final String name, final Class<T> type, final T value) {
        this.staticConstants.add(new StaticConstant(name, type, value));
    }
     ...
     */
    public final Set<StaticConstant> getStaticConstants() {
