...
import org.opendaylight.mdsal.binding.javav2.dom.codec.impl.codecs.UnmappedOperationInputCodec;
...
public final class SchemaRootCodecContext<D extends TreeNode> extends DataContainerCodecContext<D, SchemaContext> {
    ...
    private ContainerNodeCodecContext<?> createOperationDataContext(final Class<?> key) {
        ...
        final ContainerSchemaNode schema = getDataSchema(operation, qname);// SchemaNodeUtils.getRpcDataSchema(operation,
                                                                           // qname);
    ...
    private ContainerSchemaNode getDataSchema(final OperationDefinition operation, final QName qname) {
