 ...
 */
package org.opendaylight.mdsal.binding.javav2.dom.codec.writer.spi.generator;
...
import org.opendaylight.mdsal.binding.javav2.dom.codec.writer.api.TreeNodeSerializerGenerator;
import org.opendaylight.mdsal.binding.javav2.dom.codec.writer.impl.StaticConstant;
import org.opendaylight.mdsal.binding.javav2.dom.codec.writer.impl.TreeNodeSerializerPrototype;
import org.opendaylight.mdsal.binding.javav2.dom.codec.writer.spi.source.AbstractTreeNodeSerializerSource;
import org.opendaylight.mdsal.binding.javav2.generator.impl.util.BindingRuntimeContext;
import org.opendaylight.mdsal.binding.javav2.generator.impl.util.JavassistUtils;
...
public abstract class AbstractStreamWriterGenerator extends AbstractGenerator implements TreeNodeSerializerGenerator {
    ...
    private final class SerializerImplementationLoader extends CacheLoader<Class<?>, TreeNodeSerializerImplementation> {
        ...
        public TreeNodeSerializerImplementation load(final Class<?> type) throws Exception {
        ...
        private Class<? extends TreeNodeSerializerImplementation> generateSerializer(final Class<?> type,
             ...
             * the class.
             */
            for (final StaticConstant constant : source.getStaticConstants()) {
        ...
        try {
            product = javassist.instantiatePrototype(TreeNodeSerializerPrototype.class.getName(), serializerName,
                    cls -> {
                        ...
                        for (final StaticConstant def : source.getStaticConstants()) {
