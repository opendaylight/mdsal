...
import org.opendaylight.mdsal.gen.javav2.urn.opendaylight.params.xml.ns.yang.mdsal.test.binding.rev140701.data.top.top_level_list.choice_in_list.SimpleCase;
...
public class InstanceIdentifierTest extends AbstractBindingRuntimeTest {
    ...
    private static final InstanceIdentifier<SimpleCase> BA_SIMPLE_CASE = InstanceIdentifier.builder(Top.class)
        .child(TopLevelList.class, TOP_FOO_KEY).child(SimpleCase.class).build();
    ...
    public void testInstanceIdentifierOfCase() {
        assertTrue(SimpleCase.getInstanceIdentifier(TOP_FOO_KEY).equals(BA_SIMPLE_CASE));
    }
