 ...
 */
@Beta
public interface DataObjectModification<T extends TreeNode> extends Identifiable<TreeArgument> {
     ...
     */
    @Nonnull
    Collection<DataObjectModification<? extends TreeNode>> getModifiedChildren();
     ...
     *         to generated model.
     */
    <C extends TreeChildNode<? super T, ?>> Collection<DataObjectModification<C>> getModifiedChildren (
     ...
     *         to generated model.
     */
    @Nullable <C extends TreeChildNode<? super T, ?>> DataObjectModification<C> getModifiedChildContainer (
     ...
     */
    @Nullable <C extends Augmentation<T> & TreeNode> DataObjectModification<C> getModifiedAugmentation(
     ...
     *         to generated model.
     */
    <C extends IdentifiableItem<T, K> & TreeChildNode<? super T, ?>, K extends IdentifiableItem<T, K>> DataObjectModification<C>
     ...
     *
     */
    @Nullable DataObjectModification<? extends TreeNode> getModifiedChild(TreeArgument childArgument);
