...
public class ForwardingWriteTransaction extends ForwardingObject implements WriteTransaction {
    ...
    @Override
    public <T extends TreeNode> void put(LogicalDatastoreType store,
            org.opendaylight.mdsal.binding.javav2.spec.base.InstanceIdentifier<T> path, T data) {
    ...
    @Override
    public <T extends TreeNode> void merge(LogicalDatastoreType store,
            org.opendaylight.mdsal.binding.javav2.spec.base.InstanceIdentifier<T> path, T data) {
    ...
    public void delete(LogicalDatastoreType store,
            org.opendaylight.mdsal.binding.javav2.spec.base.InstanceIdentifier<? extends TreeNode> path) {
