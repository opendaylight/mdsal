...
final class TypeGenHelper {
    ...
    SchemaNode parentNode, final SchemaContext schemaContext, ModuleContext context) {
    ...
    private static GeneratedTOBuilderImpl typedefToTransferObject(final String basePackageName, final
    TypeDefinition<?> typedef, final String moduleName, ModuleContext context) {
