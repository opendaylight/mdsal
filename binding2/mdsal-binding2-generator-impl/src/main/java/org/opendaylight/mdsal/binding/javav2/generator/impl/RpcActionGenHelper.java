...
final class RpcActionGenHelper {
            ...
            if (resolveDataSchemaNodesCheck(moduleContext.module(), schemaContext,potential)) {
                ...
                if (potential instanceof ActionNodeContainer) {
                    ...
                    for (ActionDefinition action : actions) {
                        moduleContext.addTopLevelNodeType(resolveOperation(potential, action, moduleContext,
    ...
    static void actionMethodsToGenType(final ModuleContext moduleContext,
        ...
        resolveActions(moduleContext.module(), moduleContext, schemaContext, verboseClassComments, genTypeBuilders, genCtx, typeProvider,
     ...
     */
     static void rpcMethodsToGenType(final ModuleContext moduleContext,
        ...
        for (final RpcDefinition rpc : rpcDefinitions) {
            ...
            //routedRPC?
            if (isAction) {
                moduleContext.addTopLevelNodeType(resolveOperation(parent, rpc, moduleContext, schemaContext,
