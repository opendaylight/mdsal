...
final class GenHelperUtil {
    ...
    static boolean resolveDataSchemaNodesCheck(final Module module, final SchemaContext schemaContext,
        ...
        if (!schemaNode.isAugmenting()) {
            ...
            ModelStatement<QName> node = (ModelStatement<QName>)schemaNode;
            final Module originalModule = schemaContext.findModuleByNamespaceAndRevision(node.argument().getNamespace(),
                    node.argument().getRevision());
