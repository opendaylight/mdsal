...
import org.opendaylight.mdsal.binding2.txt.yangtemplate;
...
public class YangTemplateTest {
    ...
    public void printYangSnippetForModule() {
        for (Module module : modules) {
             ...
             * 3. whole Module
             */
            final String body = yangtemplate.render(null, null, module).body();
            //FIXME: don't do it this way, only for very first attempt to show results
            System.out.println("module ".concat(module.getName()).concat(":").concat(body));
        }
