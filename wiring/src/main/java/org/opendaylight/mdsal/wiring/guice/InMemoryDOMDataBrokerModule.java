...
public class InMemoryDOMDataBrokerModule implements Module {
    ...
    @Provides
    @Singleton InMemoryDOMDataStoreConfigProperties getProperties() {
        // Override this method to read e.g. from a configuration file
        return InMemoryDOMDataStoreConfigProperties.getDefault();
    }
}
