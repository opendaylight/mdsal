 ...
 */
class AbstractDynamicSchemaWiring implements SchemaWiring {
    // intentionally package local, for now

    // TODO rename, if it indeed ends up being no longer abstract
    ...
    AbstractDynamicSchemaWiring(ScanningSchemaServiceProvider scanningSchemaServiceProvider) {
    ...
    private class YangRegistererImpl implements YangRegisterer {
        private final Logger log = LoggerFactory.getLogger(AbstractDynamicSchemaWiring.YangRegistererImpl.class);
