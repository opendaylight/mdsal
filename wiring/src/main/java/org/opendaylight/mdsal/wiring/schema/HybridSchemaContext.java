...
class HybridSchemaContext implements SchemaContext {
    ...
    HybridSchemaContext(
            SchemaContext priorityContext, SchemaContext fallbackContext) {
        this.priorityContext = requireNonNull(priorityContext, "priorityContext");
    ...
    public SchemaPath getPath() {
        return priorityContext.getPath();
    }

    @Override
    public QName getQName() {
        return priorityContext.getQName();
    }

    @Override
    public Status getStatus() {
        return priorityContext.getStatus();
    }

    @Override
    public boolean isPresenceContainer() {
        return priorityContext.isPresenceContainer();
    }

    @Override
    public boolean isConfiguration() {
        return priorityContext.isConfiguration();
    }

    @Override
    @SuppressWarnings("deprecation")
    public boolean isAugmenting() {
        return priorityContext.isAugmenting();
    }

    @Override
    @SuppressWarnings("deprecation")
    public boolean isAddedByUses() {
        return priorityContext.isAddedByUses();
    }
