...
import org.opendaylight.mdsal.wiring.BindingWiring2;
...
public class BindingModule implements Module {
    ...
    public void configure(Binder binder) {
        binder.install(new DOMModule());
    }

    @Provides
    @Singleton ClassLoadingStrategy getClassLoadingStrategy(BindingWiring2 bindingWiring) {
        return bindingWiring.getClassLoadingStrategy();
    }
