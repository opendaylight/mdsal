...
public class SchemaMountTest {
    ...
    public void test() throws YangParserException, IOException, SAXException, XMLStreamException, URISyntaxException {
        ...
        DOMSourceMountPointChild mountPointMountPointChild = createDomSourceMountPointChild("/xmls/mount-point.xml");

        DOMSourceMountPointChild libraryMountPointChild = createDomSourceMountPointChild("/xmls/yang-library.xml");
    ...
    private DOMSourceMountPointChild createDomSourceMountPointChild(String pathToXmlDataResource)
        ...
        DOMSourceMountPointChild mountPointChild = new DOMSourceMountPointChild(domSource);
