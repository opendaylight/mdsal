...
class Rfc7895ContentBuilder implements LegacyYangLibraryContentBuilder {
    ...
    @Override
    public LegacyYangLibraryContentBuilder setContext(final EffectiveModelContext modelContext) {
    ...
    @VisibleForTesting
    NormalizedNode<?, ?> formatModulesState(final EffectiveModelContext effectiveModelContext) {
