...
public final class OSGiYangLibrarySupport extends ForwardingYangLibSupport<YangLibraryContentBuilder> {
    ...
    @Override
    protected YangLibSupport<YangLibraryContentBuilder> delegate() {
