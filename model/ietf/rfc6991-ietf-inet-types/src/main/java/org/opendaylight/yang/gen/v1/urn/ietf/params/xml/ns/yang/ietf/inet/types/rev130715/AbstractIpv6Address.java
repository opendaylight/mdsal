...
public abstract class AbstractIpv6Address<T extends AbstractIpv6Address<T>> extends DerivedString<T> {
    ...
    // Due to Java object alignment we store the 128 bits as 4 integers rather than 2 longs, hence not wasting
    ...
    AbstractIpv6Address(final AbstractIpv6Address<?> other) {
        intBits0 = other.intBits0;
        intBits1 = other.intBits1;
        intBits2 = other.intBits2;
