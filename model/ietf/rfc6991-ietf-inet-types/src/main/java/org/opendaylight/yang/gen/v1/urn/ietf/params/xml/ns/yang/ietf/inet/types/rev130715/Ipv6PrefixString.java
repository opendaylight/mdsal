...
/**
 * {@link DerivedString} representation of the {@code ipv6-prefix} type as defined by ietf-inet-types.
 */
@Beta
@NonNullByDefault
public class Ipv6PrefixString extends AbstractIpv6Address<Ipv6PrefixString> {
    ...
    public final String toCanonicalString() {
        ...
        final String ret = hextetsToIPv6String(hextets) + '/' + length;
    ...
    public final boolean equals(@Nullable final Object obj) {
        ...
        if (!(obj instanceof final Ipv6PrefixString other)) {
            return false;
        }
