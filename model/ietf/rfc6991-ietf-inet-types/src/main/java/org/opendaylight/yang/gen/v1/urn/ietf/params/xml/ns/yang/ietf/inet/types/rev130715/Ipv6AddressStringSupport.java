...
public final class Ipv6AddressStringSupport extends AbstractCanonicalValueSupport<Ipv6AddressString> {
    ...
    @Override
    public Either<Ipv6AddressString, CanonicalValueViolation> fromString(final String str) {
        ...
        return Either.ofFirst(Ipv6AddressString.valueOf((Inet6Address) address, zone));
    }
}
