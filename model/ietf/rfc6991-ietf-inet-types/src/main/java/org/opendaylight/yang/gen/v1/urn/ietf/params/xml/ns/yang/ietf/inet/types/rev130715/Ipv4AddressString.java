...
/**
 * {@link DerivedString} representation of the {@code ipv4-address} type as defined by ietf-inet-types.
 */
@Beta
@NonNullByDefault
public abstract class Ipv4AddressString extends AbstractDottedQuad<Ipv4AddressString> {
    ...
    /**
     * Return the zone part of this ipv4-address, if present.
     *
     * @return Zone part, if present.
     */
    ...
    public final boolean equals(@Nullable final Object obj) {
        ...
        if (!(obj instanceof final Ipv4AddressString other)) {
            return false;
        }
