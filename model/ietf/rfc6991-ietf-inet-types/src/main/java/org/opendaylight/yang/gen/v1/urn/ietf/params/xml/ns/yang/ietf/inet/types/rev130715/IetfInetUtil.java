...
public final class IetfInetUtil {
    ...
    static {
        ...
        V4NZ_FACTORY = StringValueObjectFactory.create(lookup, Ipv4AddressNoZone.class, "0.0.0.0");
        P4_FACTORY = StringValueObjectFactory.create(lookup, Ipv4Prefix.class, "0.0.0.0/0");
        V6NZ_FACTORY = StringValueObjectFactory.create(lookup, Ipv6AddressNoZone.class, "::0");
        P6_FACTORY = StringValueObjectFactory.create(lookup, Ipv6Prefix.class, "::0/0");
    }
