...
final class MacUtil extends AbstractIetfYangUtil<MacClass, PhysClass, HexClass, QuadClass> {
    MacUtil() {
        super(MacClass.class, PhysClass.class, HexClass.class, QuadClass.class);
    }
