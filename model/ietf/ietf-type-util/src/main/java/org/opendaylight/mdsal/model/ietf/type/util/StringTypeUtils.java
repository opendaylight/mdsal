...
public final class StringTypeUtils {
    ...
    public static int findSingleHash(final String str) {
    ...
    public static int maskBits(final int intBits, final int length) {
        return intBits & MASKS[length];
    }

    public static byte first(final short shortBits) {
        return (byte)(shortBits >>> 8);
    }

    public static byte first(final int intBits) {
        return (byte) (intBits >>> 24);
    }

    public static byte first(final long longBits) {
        return (byte) (longBits >>> 56);
    }

    public static byte second(final int intBits) {
        return (byte) (intBits >>> 16);
    }

    public static byte second(final short shortBits) {
        return (byte) shortBits;
    }

    public static byte second(final long longBits) {
        return (byte) (longBits >>> 48);
    }

    public static byte third(final int intBits) {
        return (byte) (intBits >>> 8);
    }

    public static byte third(final long longBits) {
        return (byte) (longBits >>> 40);
    }

    public static byte fourth(final int intBits) {
        return (byte) intBits;
    }

    public static byte fourth(final long longBits) {
        return (byte) (longBits >>> 32);
    }

    public static byte fifth(final long longBits) {
        return (byte) (longBits >>> 24);
    }

    public static byte sixth(final long longBits) {
        return (byte) (longBits >>> 16);
    }

    public static byte seventh(final long longBits) {
        return (byte) (longBits >>> 8);
    }

    public static byte eighth(final long longBits) {
