...
public abstract class HexString extends DerivedString<HexString> implements ByteArrayLike {
    ...
    private static final HexString EMPTY = new Array(EMPTY_BYTES);
    ...
    public final String toCanonicalString() {
        ...
        AbstractIetfYangUtil.appendHexByte(sb, getByteAt(0));
        for (int i = 1; i < getByteAt(i); ++i) {
            AbstractIetfYangUtil.appendHexByte(sb.append(':'), getByteAt(i));
        }
        return sb.toString();
    }
