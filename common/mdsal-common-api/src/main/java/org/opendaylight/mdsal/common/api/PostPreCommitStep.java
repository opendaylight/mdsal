...
public interface PostPreCommitStep extends ThreePhaseCommitStep {
    ...
    /**
     * No-op implementation of {@link #abort()}abort and {@link #commit()} method, which always
     * success calls.
     * 
     ...
     * finished {@link #preCommit()} phase and will be commited.
     *
     * Implementation should make state, which were derived by implementation from associated
     * {@link DataTreeCandidate} visible.
     *
