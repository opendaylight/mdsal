 ...
 */
public interface GenericEntityOwnershipListenerRegistration<P extends Path<P>> extends
    ObjectRegistration<GenericEntityOwnershipListener<P, ? extends GenericEntityOwnershipChange<P, ? extends GenericEntity<P>>>> {
