...
public interface GenericEntityOwnershipService<P extends Path<P>, E extends GenericEntity<P>,
     ...
     */
    GenericEntityOwnershipCandidateRegistration<P> registerCandidate(@Nonnull E entity)
     ...
     */
    GenericEntityOwnershipListenerRegistration<P> registerListener(@Nonnull String entityType, @Nonnull L listener);
