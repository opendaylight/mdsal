...
@Beta
@NonNullByDefault
public abstract class TypeName implements Identifier, Immutable {
    private static final class Primitive extends TypeName {
        ...
        @Override
        public Optional<TypeName> immediatelyEnclosingClass() {
    ...
    private abstract static class Reference extends TypeName {
        private static final long serialVersionUID = 1L;
        ...
        public final String toString() {
            String local = str;
            if (local == null) {
                str = local = appendClass(new StringBuilder()).toString();
            }
            return local;
        }
     ...
     */
    public abstract Optional<TypeName> immediatelyEnclosingClass();
