...
public abstract sealed class BindingClassLoader extends ClassLoader
     ...
     */
    public static @NonNull BindingClassLoader create(final ClassLoader parentLoader) {
        final var nonnull = requireNonNull(parentLoader);
        return AccessController.doPrivileged(
            (PrivilegedAction<BindingClassLoader>)() -> new RootBindingClassLoader(nonnull));
    }
