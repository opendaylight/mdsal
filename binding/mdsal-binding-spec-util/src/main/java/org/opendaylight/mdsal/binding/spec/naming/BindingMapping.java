...
public final class BindingMapping {
    ...
    public static @NonNull String getGetterMethodForRequire(final String methodName, final boolean isBoolean) {
        checkArgument(isRequireMethodName(methodName));
        return getGetterPrefix(isBoolean) + methodName.substring(REQUIRE_PREFIX.length());
    }
