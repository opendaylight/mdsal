 ...
 * @author Robert Varga
 *
 * @deprecated This service is exposed for config subsystem only.
 */
@Deprecated
@Beta
public interface YangTextAwareBindingRuntimeContext extends SchemaSourceProvider<YangTextSchemaSource> {
    /**
