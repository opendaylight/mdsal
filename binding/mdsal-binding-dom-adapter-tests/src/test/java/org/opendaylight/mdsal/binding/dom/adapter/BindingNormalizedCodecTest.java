...
import org.opendaylight.mdsal.binding.testutils.db.AbstractSchemaAwareTest;
...
public class BindingNormalizedCodecTest extends AbstractSchemaAwareTest {
    ...
    private static class ExtendedVisibilityBindingToNormalizedNodeCodec extends BindingToNormalizedNodeCodec {
        ExtendedVisibilityBindingToNormalizedNodeCodec(ClassLoadingStrategy classLoadingStrategy,
                BindingNormalizedNodeCodecRegistry codecRegistry, boolean waitForSchema) {
            super(classLoadingStrategy, codecRegistry, waitForSchema);
        }

        @Override
        protected YangInstanceIdentifier toYangInstanceIdentifierBlocking(
                InstanceIdentifier<? extends DataObject> binding) {
    ...
    private ExtendedVisibilityBindingToNormalizedNodeCodec codec;
    ...
    protected void setupWithSchema(final SchemaContext schemaContext) {
        ...
        this.codec = new ExtendedVisibilityBindingToNormalizedNodeCodec(GeneratedClassLoadingStrategy.getTCCLClassLoadingStrategy(),
                registry, true);
    }
