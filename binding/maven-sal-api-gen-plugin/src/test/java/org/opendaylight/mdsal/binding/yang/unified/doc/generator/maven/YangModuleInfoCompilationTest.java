...
public class YangModuleInfoCompilationTest {
    ...
    public void compilationTest() throws Exception {
        ...
        assertEquals("$YangModuleInfoImpl{resource=/yang-module-info/submodule1.yang}", infoSub1.toString());
        assertNotNull(infoSub2);
        assertEquals("$YangModuleInfoImpl{resource=/yang-module-info/submodule2.yang}", infoSub2.toString());
        assertNotNull(infoSub3);
        assertEquals("$YangModuleInfoImpl{resource=/yang-module-info/submodule3.yang}", infoSub3.toString());
