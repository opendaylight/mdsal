...
final class ModifiedCandidateNode<T extends DataObject> implements DataObjectModified<T> {
    private final CandidateNodeAdapter<T, ?> adapter;

    ModifiedCandidateNode(final @NonNull CandidateNodeAdapter<T, ?> adapter) {
