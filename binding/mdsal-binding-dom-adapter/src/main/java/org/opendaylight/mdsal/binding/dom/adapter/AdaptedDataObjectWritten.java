...
final class AdaptedDataObjectWritten<T extends DataObject> extends DataObjectWritten<T> {
    private final @NonNull AbstractDataObjectModification<T, ?> mod;

    AdaptedDataObjectWritten(final @NonNull AbstractDataObjectModification<T, ?> mod) {
