...
final class ActionProviderServiceAdapter extends AbstractBindingAdapter<DOMOperationProviderService>
    ...
    private static final class Impl implements DOMOperationImplementation.Action {
        private final Class<? extends org.opendaylight.yangtools.yang.binding.Action<?, ?, ?>> actionInterface;
        private final org.opendaylight.yangtools.yang.binding.Action implementation;
        ...
        Impl(final BindingNormalizedNodeSerializer codec, final NodeIdentifier outputName,
                final Class<? extends org.opendaylight.yangtools.yang.binding.Action<?, ?, ?>> actionInterface,
                        final org.opendaylight.yangtools.yang.binding.Action<?, ?, ?> implementation) {
