...
final class PublisherAdapter<N extends InstanceNotification<N, P>, P extends DataObject>
    ...
    @Override
    public void putNotification(final DataTreeIdentifier<P> path, final N notification) throws InterruptedException {
    ...
    @Override
    public ListenableFuture<? extends Object> offerNotification(final DataTreeIdentifier<P> path,
    ...
    @Override
    public ListenableFuture<? extends Object> offerNotification(final DataTreeIdentifier<P> path, final N notification,
    ...
    private static @NonNull DOMDataTreeIdentifier toDomPath(final CurrentAdapterSerializer serializer,
        ...
        return new DOMDataTreeIdentifier(path.getDatastoreType(),
            serializer.toYangInstanceIdentifier(path.getRootIdentifier()));
    }
