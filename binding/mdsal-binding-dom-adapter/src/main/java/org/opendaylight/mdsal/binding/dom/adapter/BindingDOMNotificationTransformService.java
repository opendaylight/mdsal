...
final class BindingDOMNotificationTransformService implements NotificationTransformService {
    ...
    private static class Builder extends BindingDOMAdapterBuilder<NotificationTransformService> {
        ...
        @Override
        protected NotificationTransformService createInstance(final ClassToInstanceMap<DOMService> delegates) {
            final var domNotification = delegates.getInstance(DOMNotificationService.class);
