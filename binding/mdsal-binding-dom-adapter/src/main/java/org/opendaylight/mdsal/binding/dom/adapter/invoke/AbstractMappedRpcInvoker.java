...
abstract class AbstractMappedRpcInvoker<T> extends RpcServiceInvoker {
    ...
    @VisibleForTesting
    final ImmutableMap<T, RpcMethodInvoker> map;

    AbstractMappedRpcInvoker(final Map<T, Method> map) {
    ...
    @Override
    public @Nullable RpcMethodInvoker getMethodInvoker(@NonNull final QName rpcName) {
