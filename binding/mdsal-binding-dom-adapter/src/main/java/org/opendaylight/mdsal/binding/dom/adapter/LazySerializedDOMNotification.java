...
final class LazySerializedDOMNotification implements DOMNotification, DOMEvent {
    private static final LoadingCache<Class<? extends Notification>, Absolute> PATHS =
        CacheBuilder.newBuilder().weakKeys().build(new CacheLoader<Class<? extends Notification>, Absolute>() {
            @Override
