            ...
            if (domChildNode.modificationType() != UNMODIFIED) {
                ...
                if (type != BindingStructuralType.NOT_ADDRESSABLE) {
                    ...
                    try {
                        ...
                        } else if (childCodec instanceof BindingDataContainerCodecTreeNode<?> childContainerCodec) {
                            // FIXME: we should have a dedicated node for this
                            populateList(result, childContainerCodec, domChildNode, domChildNode.childNodes());
                        } else {
