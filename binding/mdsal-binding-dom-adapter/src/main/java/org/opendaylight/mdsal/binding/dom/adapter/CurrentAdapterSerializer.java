...
public final class CurrentAdapterSerializer extends ForwardingBindingDOMCodecServices {
    ...
    @Nullable ContextReferenceExtractor findExtractor(final @NonNull RpcInputArchetype inputType) {
        final var inputName = inputType.name();
        ...
        try {
            ...
            throw new IllegalArgumentException("Failed to load class for " + inputName, e);
        }
