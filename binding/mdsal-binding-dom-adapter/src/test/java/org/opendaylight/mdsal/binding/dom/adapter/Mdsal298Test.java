...
public class Mdsal298Test extends AbstractDataBrokerTest {
    ...
    private static final DataTreeIdentifier<Container> CONTAINER_TID =
        DataTreeIdentifier.of(CONFIGURATION, CONTAINER);
    ...
    public void testKeyedDataTreeModification() throws InterruptedException, ExecutionException {
        final var listener = assertWrittenContainer(Container.QNAME, Container.class, new ContainerBuilder().build());

        final var domTx = getDomBroker().newWriteOnlyTransaction();
    ...
    public void testDataTreeModificationAddressable() throws InterruptedException, ExecutionException {
        final var listener = assertWrittenContainer(AddressableCont.QNAME, AddressableCont.class,
            new AddressableContBuilder().build());
        ...
        assertEquals(ADDRESSABLE_CONTAINER_TID, contChange.path());
