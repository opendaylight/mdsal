...
final class KarafFeaturesSupport {
        ...
        public YangModuleInfoRegistry wrap(final BundleContext ctx, final RegularYangModuleInfoRegistry delegate) {
            ...
            if (ref != null) {
                ...
                if (features != null) {
                    ...
                    return new KarafYangModuleInfoRegistry(features, delegate);
                }
            }
            return delegate;
        }
    ...
    private static final WrapperFunction WRAPPER;

    static {
        WrapperFunction karaf;
        try {
            karaf = new KarafWrapperFunction();
        ...
        WRAPPER = karaf != null ? karaf : new NoopWrapperFunction();
    }
