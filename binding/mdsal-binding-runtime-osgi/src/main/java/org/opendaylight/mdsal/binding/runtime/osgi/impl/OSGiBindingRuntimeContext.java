...
public final class OSGiBindingRuntimeContext extends AbstractBindingRuntimeContext {
    ...
    static final String GENERATION_KEY = "org.opendaylight.mdsal.binding.runtime.osgi.BindingRuntimeContextGeneration";
    ...
    void activate(final Map<String, ?> allProperties) {
        ...
        generation = allProperties.get(GENERATION_KEY);
