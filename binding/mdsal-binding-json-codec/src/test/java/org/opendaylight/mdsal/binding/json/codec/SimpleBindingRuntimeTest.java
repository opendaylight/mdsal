...
public class SimpleBindingRuntimeTest extends AbstractBindingRuntimeTest {
    ...
    public void testSimpleContainerSerialization() throws IOException {
        ...
        final var normalizedNode = BINDING_CODEC_CONTEXT
                .toNormalizedDataObject(InstanceIdentifier.create(Cont.class), cont)
                .node();
        ...
        final String serviceOutputString = JSONCodec.serialize(InstanceIdentifier.create(Cont.class), cont);
    ...
    public void testSimpleContainerDeserialization() throws IOException {
        ...
        final DataObject resultDataObject = JSONCodec.deserialize(InstanceIdentifier.create(Cont.class),
                serializedContainer);
