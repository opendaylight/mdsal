...
public final class BindingIndependentMappingService {
    ...
    public static <T extends DataObject> NormalizedNode toDataDom(final InstanceIdentifier<T> path, final T data) {
        return BINDING_CODEC_CONTEXT.toNormalizedDataObject(path, data).node();
    }

    public static DataObject fromDataDom(final QName nodeType, final NormalizedNode node) {
