...
public final class JSONCodec {
    ...
    public <T extends DataObject> String serialize(final InstanceIdentifier<T> path, final T dataObject)
            throws IOException {
    ...
    public <T extends DataObject> DataObject deserialize(final InstanceIdentifier<T> path, final String str)
            throws IOException {
        final var targetType = path.getTargetType();
