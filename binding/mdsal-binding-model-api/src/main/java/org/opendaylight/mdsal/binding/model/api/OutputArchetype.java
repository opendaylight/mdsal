 ...
 */
@NonNullByDefault
public final class OutputArchetype extends DataObjectArchetype<OutputEffectiveStatement> {
    OutputArchetype(final JavaTypeName typeName, final OutputEffectiveStatement statement,
