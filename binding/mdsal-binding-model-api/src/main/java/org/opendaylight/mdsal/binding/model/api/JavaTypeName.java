...
public abstract sealed class JavaTypeName implements Comparable<JavaTypeName>, Identifier, Immutable {
    ...
    private static final class Nested extends Reference {
        ...
        @Override
        int compareToEnclosing(final @Nullable JavaTypeName otherEnclosing) {
    ...
    public final int compareTo(final JavaTypeName o) {
        ...
        var cmp = simpleName.compareTo(o.simpleName);
        if (cmp != 0) {
            return cmp;
        }
        cmp = packageName().compareTo(o.packageName());
        return cmp != 0 ? cmp : compareToEnclosing(o.immediatelyEnclosingClass());
    }

    int compareToEnclosing(final @Nullable JavaTypeName otherEnclosing) {
        return otherEnclosing == null ? 0 : -1;
    }
