...
@Beta
@NonNullByDefault
public sealed interface Archetype extends Type, Immutable permits Archetype.WithStatement, DataObjectBuilderArchetype {
    ...
    sealed interface WithStatement extends Archetype
            permits ActionArchetype, AnnotationArchetype, ChoiceArchetype, DataObjectArchetype, FeatureArchetype,
                    ...
                    TypeObjectArchetype, YangDataArchetype {
        /**
