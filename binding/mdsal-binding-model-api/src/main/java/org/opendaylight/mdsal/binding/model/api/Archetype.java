...
public sealed interface Archetype extends Type, Immutable
        permits Archetype.WithStatement, Archetype.WithClass, Archetype.WithInterface,
                Archetype.WithGroupings, DataObjectBuilderArchetype {
    ...
    sealed interface WithClass extends Archetype
            permits BitsArchetype, FeatureArchetype, ScalarArchetype, UnionArchetype {
        @Override
    ...
    sealed interface WithInterface extends Archetype
            permits ActionArchetype, ChoiceArchetype, GroupingArchetype, IdentityArchetype, OpaqueObjectArchetype,
                    RpcArchetype, YangDataArchetype {
        @Override
