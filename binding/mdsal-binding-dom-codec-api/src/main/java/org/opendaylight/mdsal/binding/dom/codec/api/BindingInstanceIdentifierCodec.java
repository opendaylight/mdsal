...
public interface BindingInstanceIdentifierCodec extends Immutable {
    ...
    @NonNull YangInstanceIdentifier fromBinding(org.opendaylight.mdsal.binding.api.@NonNull InstanceIdentifier<?> bindingPath);

    @NonNull YangInstanceIdentifier fromBinding(org.opendaylight.mdsal.binding.api.@NonNull InstanceWildcard<?> bindingPath);
}
