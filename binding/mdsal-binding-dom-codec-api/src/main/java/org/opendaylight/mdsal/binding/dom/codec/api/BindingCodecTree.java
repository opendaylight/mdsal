...
public interface BindingCodecTree extends BindingDataObjectCodecTreeParent<Empty> {
    ...
    /**
     * Get the {@link BindingYangDataCodec} corresponding to a particular generated {@link YangData} type.
     *
     * @param <T> {@link YangData} type
     * @param yangDataClass Class object of {@link YangData} type
     * @return A {@link BindingYangDataCodec}
     ...
     */
    <T extends YangData<T>> @NonNull BindingYangDataCodec<T> getYangDataCodec(Class<T> yangDataClass);

    /**
     * Get the {@link BindingYangDataCodec} corresponding to a particular {@link YangDataName}.
     *
     ...
     */
    @NonNull BindingYangDataCodec<?> getYangDataCodec(YangDataName yangDataName);
}
