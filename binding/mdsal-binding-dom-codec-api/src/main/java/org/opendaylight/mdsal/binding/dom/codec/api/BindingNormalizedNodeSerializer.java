...
public interface BindingNormalizedNodeSerializer {
    ...
    @NonNull YangInstanceIdentifier toYangInstanceIdentifier(org.opendaylight.yangtools.yang.binding.@NonNull InstanceIdentifier<?> binding);
     ...
     */
    // FIXME: MDSAL-525: reconcile this with BindingInstanceIdentifierCodec
    <T extends DataObject> org.opendaylight.yangtools.yang.binding.@Nullable InstanceIdentifier<T> fromYangInstanceIdentifier(
