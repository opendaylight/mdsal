...
import org.opendaylight.mdsal.dom.testkit.spi.AbstractDOMServiceTestKit.DTCLPolicy.Capture;
 ...
 */
@Beta
public abstract class AbstractBindingServiceAwareTest extends AbstractBindingServiceTestKit {
    ...
    protected <T extends DataObject> @NonNull DTCLPolicy dtclPolicyFor(final DataTreeIdentifier<T> treeId,
            final DataTreeChangeListener<T> listener) {
        return DTCLPolicy.PASS;
    }
    ...
    private final class TestingDataBroker extends ForwardingDataBroker {
        ...
        public <T extends DataObject, L extends DataTreeChangeListener<T>> ListenerRegistration<L>
            ...
            final DTCLPolicy policy = dtclPolicyFor(treeId, listener);
