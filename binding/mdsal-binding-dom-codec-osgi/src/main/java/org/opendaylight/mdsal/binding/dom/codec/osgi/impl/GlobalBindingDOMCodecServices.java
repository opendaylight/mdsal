...
import org.opendaylight.mdsal.binding.runtime.osgi.impl.GlobalBindingRuntimeContext;
...
public final class GlobalBindingDOMCodecServices extends ForwardingBindingDOMCodecServices
    ...
    @Reference(cardinality = ReferenceCardinality.AT_LEAST_ONE, updated = "update")
    ...
    void deactivate() {
        delegate = null;
        LOG.info("Global Binding/DOM Codec deactivated", generation);
    }
