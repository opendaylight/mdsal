...
/**
 * Constants and utilities relating to location and content of the descriptor XML file.
 */
@Beta
@NonNullByDefault
public final class ConfigurationDescriptors {
    ...
    public static InputStream newDescriptorSchemaStream() {
        return verifyNotNull(ConfigurationDescriptors.class.getResourceAsStream("/scr-configuration.xsd"));
    }
    ...
    private ConfigurationDescriptors() {
        // Hidden on purpose
    }
}
