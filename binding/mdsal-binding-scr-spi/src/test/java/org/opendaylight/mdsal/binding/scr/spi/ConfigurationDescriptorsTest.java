...
public class ConfigurationDescriptorsTest {
    @Test
    public void testValidSchema() {
        assertNotNull(ConfigurationDescriptors.descriptorSchema());
    }
    ...
    public void testDuplicateType() {
        assertFailureEndsWith(
            ...
            "<cfg:initial xmlns:cfg=\"http://org.opendaylight.mdsal/xmlns/scr-configuration/v0.1.0\">\n"
                ...
                + "       name=\"INITIAL_CONT\"/>\n"
                + "<field type=\"org.opendaylight.yang.gen.v1.urn.test.rev170101.Cont\"\n"
                + "       package=\"org.opendaylight.mdsal.binding.scr.it2\"\n"
                + "       class=\"ExampleTestImplementation2\"\n"
                + "       name=\"INITIAL_CONT2\"/>\n"
                + "</cfg:initial>");
    }
    ...
    private static void validate(final String xml) throws IOException, SAXException {
        ConfigurationDescriptors.descriptorSchema().newValidator().validate(new StreamSource(new StringReader(xml)));
    }
}
