...
import org.opendaylight.mdsal.dom.testkit.spi.AbstractDOMTestKit.ListenerPolicy.Capture;
...
public class TestKit extends AbstractTestKit<BindingDOMDataBrokerAdapter> {
    ...
    public TestKit(final DOMTestKit domTestKit, final TreeChangeListenerClassifier classifier) {
    ...
    protected BindingDOMDataBrokerAdapter createDataBroker() {
        return new BindingDOMDataBrokerAdapter(domTestKit().domDataBroker(), codecRegistry());
    }
