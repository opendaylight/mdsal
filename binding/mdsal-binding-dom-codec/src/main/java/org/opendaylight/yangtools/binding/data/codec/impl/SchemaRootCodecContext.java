...
final class SchemaRootCodecContext<D extends DataObject> extends DataContainerCodecContext<D,SchemaContext> {
    ...
    private final LoadingCache<SchemaPath, BindingNormalizedNodeCodec<?>> rpcDataByPath = CacheBuilder
            .newBuilder().build(new CacheLoader<SchemaPath, BindingNormalizedNodeCodec<?>>() {

                @SuppressWarnings({ "rawtypes", "unchecked" })
                @Override
                public BindingNormalizedNodeCodec load(final SchemaPath key) {
    ...
    BindingNormalizedNodeCodec<?> getRpc(final SchemaPath notification) {
