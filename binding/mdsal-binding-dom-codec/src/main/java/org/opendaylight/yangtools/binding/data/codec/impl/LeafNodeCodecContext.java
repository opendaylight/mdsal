...
final class LeafNodeCodecContext<D extends DataObject> extends NodeCodecContext<D> implements NodeContextSupplier {
    ...
    private static Object createDefaultObject(final DataSchemaNode schema, final Codec<Object, Object> codec) {
        if (schema instanceof LeafSchemaNode) {
            ...
            if (defaultValue != null) {
                return castDefaultObject(codec, type, defaultValue);
            }
            else {
                while (type != null && type.getDefaultValue() == null) {
                ...
                if (defaultValue != null) {
                    ...
                    if (defaultValue instanceof IdentityEffectiveStatementImpl) {
    ...
    private static Object castDefaultObject(final Codec<Object, Object> codec, final TypeDefinition<?> type,
    Object defaultValue) {
