...
abstract class AugmentableDataNodeContainerEmitterSource extends DataNodeContainerSerializerSource {
    ...
    AugmentableDataNodeContainerEmitterSource(final AbstractStreamWriterGenerator generator,
    ...
    protected void emitAfterBody(final StringBuilder build) {
        build.append(statement(invoke(AUGMENTABLE_SERIALIZER, "serialize", REGISTRY, INPUT, STREAM)));
    }
}