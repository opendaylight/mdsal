 ...
 */
public abstract class AbstractDataObject<T extends DataObject> implements DataObject {
    ...
    public AbstractDataObject(final DataObjectCodecContext<T, ?> ctx, final NormalizedNodeContainer<?, ?, ?> data) {
    ...
    public final boolean equals(final Object obj) {
        ...
        if (other instanceof AbstractDataObject) {
            return data.equals(((AbstractDataObject<?>) obj).data);
        }
