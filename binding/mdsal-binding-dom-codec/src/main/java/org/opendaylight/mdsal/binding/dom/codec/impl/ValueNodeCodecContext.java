...
abstract class ValueNodeCodecContext extends NodeCodecContext implements NodeContextSupplier {
    abstract static class WithCodec extends ValueNodeCodecContext {
        private final @NonNull DomLocalCodec<Object, Object> valueCodec;

        WithCodec(final DataSchemaNode schema, final DomLocalCodec<Object, Object> codec,
        ...
        @Override
        final DomLocalCodec<Object, Object> getValueCodec() {
            return valueCodec;
        }
    }
    ...
    abstract DomLocalCodec<Object, Object> getValueCodec();
