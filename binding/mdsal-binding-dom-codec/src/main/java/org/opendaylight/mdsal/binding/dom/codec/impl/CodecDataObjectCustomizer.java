    ...
    public void customize(final CodecClassLoader loader, final CtClass bindingClass, final CtClass generated)
        ...
        for (Method method : methods) {
            ...
            getter.setBody(new StringBuilder()
                ...
                // TODO: this is the only reason we need an updater, which is costing us a ton of ARFU instances
                //       can we use double-checked loading instead? On the other hand, whatever bytecode we generate
                //       here is going to cost us, too, so it has to be worth more than 36-52 bytes we would save
        ...
        // ... equals
        final CtMethod codecEquals = new CtMethod(CT_BOOLEAN, "codecEquals", new CtClass[] { CT_DATAOBJECT }, generated);
        ...
        final CtMethod codecFillToString = new CtMethod(CT_HELPER, "codecFillToString", new CtClass[] { CT_HELPER },
            generated);
