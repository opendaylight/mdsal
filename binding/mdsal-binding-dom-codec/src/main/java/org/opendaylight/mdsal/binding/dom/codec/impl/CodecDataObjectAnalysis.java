...
final class CodecDataObjectAnalysis<R extends CompositeRuntimeType> {
    ...
    final @NonNull ImmutableMap<Method, ValueNodeCodecContext> leafNodes;
    ...
    private CodecDataObjectAnalysis(final DataContainerCodecPrototype<R> prototype, final Method keyMethod) {
    ...
    private static @NonNull DataContainerCodecPrototype<?> getChildPrototype(final CompositeRuntimeType type,
            final CodecContextFactory factory, final Class<? extends DataContainer> childClass) {
