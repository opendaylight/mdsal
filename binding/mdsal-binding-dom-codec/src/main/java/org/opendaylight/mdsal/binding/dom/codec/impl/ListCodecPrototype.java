 ...
 */
final class ListCodecPrototype extends DataObjectCodecPrototype<ListRuntimeType> {
    ...
    ListCodecContext<?> createInstance() {
        // FIXME: further split up
        return KeyAware.class.isAssignableFrom(getBindingClass())
            ? KeyedListNodeCodecContext.create(this) : new ListCodecContext<>(this);
    }
}
