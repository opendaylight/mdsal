...
// Non-final for DI package
public class SimpleBindingDOMCodecFactory implements BindingDOMCodecFactory {
    private static final Logger LOG = LoggerFactory.getLogger(SimpleBindingDOMCodecFactory.class);

    @Override
    public final BindingDOMCodecServices createBindingDOMCodec(final BindingRuntimeContext context) {
