...
final class DataContainerCodecPrototype<T extends RuntimeTypeContainer> implements NodeContextSupplier {
    ...
    static <T extends CompositeRuntimeType> DataContainerCodecPrototype<T> from(final Class<?> cls, final T schema,
            final CodecContextFactory factory) {
        return new DataContainerCodecPrototype<>(cls, NodeIdentifier.create(schema.schema().argument()), schema,
            factory);
    }
    ...
    static <T extends CompositeRuntimeType> DataContainerCodecPrototype<T> from(final Item<?> bindingArg,
        ...
        return new DataContainerCodecPrototype<>(bindingArg, NodeIdentifier.create(schema.schema().argument()), schema,
            factory);
    }
