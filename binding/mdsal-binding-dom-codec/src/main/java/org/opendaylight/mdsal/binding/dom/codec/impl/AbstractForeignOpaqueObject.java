 ...
 */
@Beta
public abstract class AbstractForeignOpaqueObject<T extends OpaqueObject<T>> extends AbstractOpaqueObject<T> {
    ...
    public AbstractForeignOpaqueObject(final OpaqueData<?> value) {
