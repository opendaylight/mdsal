 ...
 */
// FIXME: this class has no run-time dependencies on other generated types, hence is a prime candidate for becoming
//        a prototype instantiated in a separate ClassLoader (see MDSAL-401) and not being a proxy at all.
