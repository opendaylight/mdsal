...
public abstract class AugmentableCodecDataObject<T extends DataObject & Augmentable<T>>
    ...
    private ImmutableMap<Class<? extends Augmentation<T>>, Augmentation<T>> cachedAugmentations;
    ...
    public final ImmutableMap<Class<? extends Augmentation<T>>, Augmentation<T>> augmentations() {
        ImmutableMap<Class<? extends Augmentation<T>>, Augmentation<T>> local = acquireAugmentations();
        if (local != null) {
            return local;
        }
        ...
        return witness == null ? local : (ImmutableMap<Class<? extends Augmentation<T>>, Augmentation<T>>) witness;
    }
