...
public abstract class AbstractAugmentableDataObject<T extends DataObject & Augmentable<T>>
    ...
    private static final AtomicReferenceFieldUpdater<AbstractDataObject, ImmutableClassToInstanceMap>
            CACHED_AUGMENTATIONS_UPDATER = AtomicReferenceFieldUpdater.newUpdater(AbstractDataObject.class,
