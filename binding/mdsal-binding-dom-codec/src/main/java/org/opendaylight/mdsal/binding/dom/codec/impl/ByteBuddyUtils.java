...
final class ByteBuddyUtils {
    ...
    static StackManipulation getField(final Field field) {
        return fieldAccess(field).read();
    }

    static StackManipulation getField(final TypeDescription instrumentedType, final String fieldName) {
        return fieldAccess(instrumentedType.getDeclaredFields(), fieldName).read();
    }

    static StackManipulation getField(final Context implementationContext, final String fieldName) {
        return getField(implementationContext.getInstrumentedType(), fieldName);
    }

    static StackManipulation putField(final Field field) {
        return fieldAccess(field).write();
    }

    static StackManipulation putField(final TypeDescription instrumentedType, final String fieldName) {
        return fieldAccess(instrumentedType.getDeclaredFields(), fieldName).write();
    }

    static StackManipulation putField(final Context implementationContext, final String fieldName) {
        return putField(implementationContext.getInstrumentedType(), fieldName);
    }
    ...
    private static Defined fieldAccess(final Field field) {
        return FieldAccess.forField(new ForLoadedField(field).asDefined());
    }
