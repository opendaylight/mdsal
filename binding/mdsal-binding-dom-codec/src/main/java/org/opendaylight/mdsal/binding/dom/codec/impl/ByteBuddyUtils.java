...
final class ByteBuddyUtils {
    ...
    static StackManipulation invokeMethod(final String clazz, final ClassLoader loader, final String name,
            final Class<?>... args) {
        return MethodInvocation.invoke(describe(clazz, loader, name, args));
    }
    ...
    private static ForLoadedMethod describe(final String clazz, final ClassLoader loader, final String name,
            final Class<?>... args) {
        return describe(getMethod(getClass(clazz, loader), name, args));
    }
