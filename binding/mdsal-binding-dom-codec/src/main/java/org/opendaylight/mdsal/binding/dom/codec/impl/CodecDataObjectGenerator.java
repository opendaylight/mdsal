 ...
 * becoming synonymous with operations on a field. Even though the field itself is declared without further modifiers,
 * it is only ever accessed through helper method using VarHandles -- and those helpers are using relaxed field ordering
