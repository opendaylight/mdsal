...
public class ExceptionReportingTest {
    ...
    private static final YangInstanceIdentifier BI_TREE_LEAF_ONLY =
            FULL_CODEC.toYangInstanceIdentifier(BA_TREE_LEAF_ONLY);
    ...
    public void testBindingIncorrectAugment() {
        FULL_CODEC.toYangInstanceIdentifier(
                InstanceIdentifier.create(Top.class).augmentation((Class) TreeComplexUsesAugment.class));
    }
