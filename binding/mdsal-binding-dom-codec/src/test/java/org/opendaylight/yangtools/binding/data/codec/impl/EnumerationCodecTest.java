...
import static org.opendaylight.yangtools.binding.data.codec.impl.EnumerationCodecTest.TestEnum.ENUM;
...
public class EnumerationCodecTest {
    ...
    public void basicTest() throws Exception {
        ...
        doReturn(ENUM.name()).when(pair).getName();
        ...
        assertEquals(codec.deserialize(codec.serialize(ENUM)), ENUM);
        assertEquals(codec.serialize(codec.deserialize(ENUM.name())), ENUM.name());
    }
}