...
public class InstanceIdentifierSerializeDeserializeTest extends AbstractBindingCodecTest {
    ...
    private static final InstanceIdentifier<ContainerWithUses> BA_TREE_COMPLEX_USES =
            BA_TOP_LEVEL_LIST.augmentationChild(ContainerWithUses.class);
    ...
    public void testBindingAwareIIToYangIIAugmentation() {
        ...
        assertTrue(lastArg instanceof NodeIdentifier);
    }
