...
public class InstanceIdentifierTest extends AbstractBindingRuntimeTest {
    ...
    public void testChoiceCaseGroupingAddressing() {
      ...
      assertEquals(YangInstanceIdentifier.create(NodeIdentifier.create(GrpCont.QNAME)), rootBase);
      ...
      assertEquals(YangInstanceIdentifier.create(
          NodeIdentifier.create(GrpCont.QNAME.withModule(RootAug.QNAME.getModule()))), rootBase);
    }
}
