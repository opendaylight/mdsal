...
public class ActionSerializeDeserializeTest extends AbstractBindingCodecTest {
    ...
    public void testSerialization() {
        assertEquals(DOM_FOO_INPUT, registry.toNormalizedNodeActionInput(Foo.class, BINDING_FOO_INPUT));
        assertEquals(DOM_BAR_INPUT, registry.toNormalizedNodeActionInput(Bar.class, BINDING_BAR_INPUT));
        assertEquals(DOM_FOO_OUTPUT, registry.toNormalizedNodeActionOutput(Foo.class, BINDING_FOO_OUTPUT));
        assertEquals(DOM_BAR_OUTPUT, registry.toNormalizedNodeActionOutput(Bar.class, BINDING_BAR_OUTPUT));
    }
