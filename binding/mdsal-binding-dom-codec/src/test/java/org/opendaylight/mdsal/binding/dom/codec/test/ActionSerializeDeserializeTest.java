...
public class ActionSerializeDeserializeTest extends AbstractBindingCodecTest {
    ...
    public void testSerialization() {
        assertEquals(DOM_FOO_INPUT, this.registry.toLazyNormalizedNodeActionInput(Foo.class, BINDING_FOO_INPUT)
                .getDelegate());
        assertEquals(DOM_BAR_INPUT, this.registry.toLazyNormalizedNodeActionInput(Bar.class, BINDING_BAR_INPUT)
                .getDelegate());
        assertEquals(DOM_FOO_OUTPUT, this.registry.toLazyNormalizedNodeActionOutput(Foo.class, BINDING_FOO_OUTPUT)
                .getDelegate());
        assertEquals(DOM_BAR_OUTPUT, this.registry.toLazyNormalizedNodeActionOutput(Bar.class, BINDING_BAR_OUTPUT)
                .getDelegate());
    }

    @Test
    public void testKeyedListActionSerialization() {
        assertEquals(DOM_FOOIO_INPUT, this.registry.toLazyNormalizedNodeActionInput(Fooio.class, BINDING_FOOIO_INPUT)
                .getDelegate());
        assertEquals(DOM_FOOIO_OUTPUT, this.registry.toLazyNormalizedNodeActionOutput(Fooio.class, BINDING_FOOIO_OUTPUT)
                .getDelegate());
    }

    @Test
    public void testDeserialization() {
        assertEquals(BINDING_FOO_INPUT, this.registry.fromNormalizedNodeActionInput(Foo.class, DOM_FOO_INPUT));
        assertEquals(BINDING_BAR_INPUT, this.registry.fromNormalizedNodeActionInput(Bar.class, DOM_FOO_INPUT));
        assertEquals(BINDING_FOO_OUTPUT, this.registry.fromNormalizedNodeActionOutput(Foo.class, DOM_FOO_OUTPUT));
        assertEquals(BINDING_BAR_OUTPUT, this.registry.fromNormalizedNodeActionOutput(Bar.class, DOM_FOO_INPUT));
    }

    @Test
    public void testKeyedListActionDeserialization() {
        assertEquals(BINDING_FOOIO_INPUT, this.registry.fromNormalizedNodeActionInput(Fooio.class, DOM_FOOIO_INPUT));
        assertEquals(BINDING_FOOIO_OUTPUT, this.registry.fromNormalizedNodeActionOutput(Fooio.class, DOM_FOOIO_OUTPUT));
    }
}
