...
public abstract class AbstractDOMServiceTestKit<D extends DOMDataBroker> extends EffectiveModelContextTestKit
    ...
    public static class DTCLPolicy {
        ...
        private static final class Capture extends DTCLPolicy {
            final Object marker;

            public Capture(final Object marker) {
    ...
    public interface DTCLClassifier {
        ...
        DTCLPolicy policyFor(DataTreeIdentifier<?> treeId, DataTreeChangeListener<?> listener);
    }
    ...
    private volatile D domDataBroker;
    ...
    public void close() {
        if (domDataBroker != null) {
            closeDomDataBroker(domDataBroker);
        }
    }
    ...
    private @NonNull D createDomDataBroker() {
        ...
        return createDomDataBroker(datastores);
    }
}
