 ...
 */
@Beta
public abstract class AbstractBindingServiceAwareTest extends AbstractDOMServiceAwareTest {
    ...
    protected synchronized final void runEvents(final DataTreeChangeEventPredicate predicate) {
    ...
    synchronized final void addEvent(final CapturedDataTreeChangeEvent<?> event) {
        events.add(event);
    }
