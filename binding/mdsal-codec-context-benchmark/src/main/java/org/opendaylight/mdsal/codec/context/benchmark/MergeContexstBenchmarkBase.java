...
public abstract class MergeContexstBenchmarkBase {
    private static final Logger LOG = LoggerFactory.getLogger(ContextBenchmarkBase.class);
    ...
    public void setup() throws ClassNotFoundException {
        ...
        for (int i = 1; i <= 6000; i++) {
            ...
            rootCodecContext
                    .streamChild((Class<? extends DataObject>)loader.loadClass(packageName + ".Rpc" + i + "Input"));
            rootCodecContext
                    .streamChild((Class<? extends DataObject>)loader.loadClass(packageName + ".Rpc" + i + "Output"));
        }
    }
