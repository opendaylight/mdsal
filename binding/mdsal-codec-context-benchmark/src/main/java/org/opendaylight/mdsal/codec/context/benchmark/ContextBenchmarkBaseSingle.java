...
@Fork(1)
public abstract class ContextBenchmarkBaseSingle {
    private static final Logger LOG = LoggerFactory.getLogger(ContextBenchmarkBaseSingle.class);

    private static BindingRuntimeContext runtimeContext;
    protected BindingContext codecContext;
