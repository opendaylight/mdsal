...
public class TestBindingMap {
    ...
    private static final List<Bar> BAR_LIST = ImmutableList.of(BAR_TWO, BAR_ONE, BAR_FOUR, BAR_THREE);
    ...
    public void orderedBuilderTest() {
        final BindingMap.Builder<BarKey, Bar> builder = BindingMap.orderedBuilder();
        final Foo foo = new FooBuilder()
                .setBar(builder.build())
                .build();
        final Map<BarKey, Bar> bar = foo.getBar();
