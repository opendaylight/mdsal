...
public class List1KeyMock
     ...
     *
     * @param attrStr the entity attrStr
     * @throws NullPointerException if any of the arguments are null
     */
    public List1KeyMock(@NonNull String attrStr) {
        this.attrStr = CodeHelpers.requireKeyProp(attrStr, "attrStr");
    }
    ...
    @Override
    public int hashCode() {
        return CodeHelpers.wrapperHashCode(attrStr);
    }

    @Override
    public final boolean equals(Object obj) {
        return this == obj || obj instanceof List1KeyMock other
                && Objects.equals(attrStr, other.attrStr);
    }
    ...
    public String toString() {
        ...
        CodeHelpers.appendValue(helper, "attrStr", attrStr);
