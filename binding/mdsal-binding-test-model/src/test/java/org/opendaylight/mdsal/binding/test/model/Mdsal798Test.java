...
public class Mdsal798Test {
    ...
    public void test() {
        ...
        assertTrue(keyedBuilder instanceof KeyedInstanceIdentifierBuilder<?, ?>);
        assertThrows(IllegalArgumentException.class, () -> keyedBuilder.child(List12.class));
        assertTrue(keyedBuilder.wildcardChild(List12.class) instanceof WildcardedInstanceIdentifierBuilder<?>);
        assertTrue(keyedBuilder.child(List12.class, new List12Key(55))
                instanceof KeyedInstanceIdentifierBuilder<?, ?>);
    }
}
