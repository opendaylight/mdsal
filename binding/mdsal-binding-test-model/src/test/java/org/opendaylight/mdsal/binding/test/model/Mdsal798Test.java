...
public class Mdsal798Test {
    ...
    @Test
    public void test() {
        assertThrows(IllegalAccessException.class, () -> InstanceIdentifier.builder(List1Mock.class).child(
                List12Mock.class, new List12KeyMock(
                Integer.valueOf("78"))));
        ...
        assertThrows(IllegalAccessException.class, () -> keyedBuilder.child(List12Mock.class));
        assertTrue(keyedBuilder.wildcardChild(List12Mock.class) instanceof
                WildcardedInstanceIdentifierBuilder<List12Mock>);
        assertTrue(keyedBuilder.child(List12Mock.class, new List12KeyMock(55)) instanceof
                KeyedInstanceIdentifierBuilder<List12Mock>);
    }
}
