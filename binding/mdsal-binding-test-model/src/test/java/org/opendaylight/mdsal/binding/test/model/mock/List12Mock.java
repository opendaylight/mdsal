        ...
        Identifiable<List12KeyMock>
{
    ...
    @Override
    default Class<List12Mock> implementedInterface() {
        return List12Mock.class;
    }
     ...
     */
    static int bindingHashCode(final @NonNull List12Mock obj) {
        final int prime = 31;
        int result = 1;
     ...
     */
    static boolean bindingEquals(final @NonNull List12Mock thisObj, final Object obj) {
        if (thisObj == obj) {
            return true;
        }
        final List12Mock other = CodeHelpers.checkCast(List12Mock.class, obj);
        if (other == null) {
            return false;
        }
     ...
     * @throws NullPointerException if {@code obj} is null
     */
    static String bindingToString(final @NonNull List12Mock obj) {
