...
/**
 * Testing {@link AbstractModuleProvider} implementation
 */
public class AbstractModuleProviderTest {
    ...
    private final Entity entity = new Entity(PROJECT_ENTITY_TYPE, TestClusterProjectProvider.class.getCanonicalName());
    private final Entity doubleEntity = new Entity(CLOSE_PROJECT_ENTITY_TYPE,
    ...
    public void setup() throws Exception {
        ...
        doReturn(mockEosEntityListReg).when(mockEos).registerListener(eq(PROJECT_ENTITY_TYPE),
                any(AbstractModuleProvider.class));
     ...
     */
    class TestClusterProjectProvider extends AbstractModuleProvider {
