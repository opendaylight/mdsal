...
public class AbstractServiceProviderTest {
    ...
    private final Entity entity = new Entity(PROJECT_ENTITY_TYPE, SERVICE_NAME);
    private final Entity doubleEntity = new Entity(CLOSE_PROJECT_ENTITY_TYPE, SERVICE_NAME);
    ...
    public void setup() throws Exception {
        ...
        doReturn(mockEosEntityListReg).when(mockEos).registerListener(eq(PROJECT_ENTITY_TYPE),
                any(AbstractServiceProvider.class));
    ...
    private EntityOwnershipChange getEntityToSlaveNoMaster() {
        return new EntityOwnershipChange(entity, EntityOwnershipChangeState.from(true, false, false));
    }
     ...
     */
    class TestClusterProjectProvider extends AbstractServiceProvider {

        private ClusterProjectProviderState testProjectProviderState;

        public TestClusterProjectProvider(final EntityOwnershipService entityOwnershipService, final String ii) {
            super(entityOwnershipService, ii);
