...
public class InstanceIdentifierTest {
    ...
    public void containsWildcarded() {
        ...
        final var wildcarded = InstanceIdentifier.builder(Nodes.class)
        ...
        final var nodeTen = InstanceIdentifier.builder(Nodes.class)
                .child(Node.class,new NodeKey(10))
                .build();
        final var nodeOne = InstanceIdentifier.builder(Nodes.class)
    ...
    public void basicTests() {
        ...
        final var instanceIdentifier3 = InstanceIdentifier.builder(Nodes.class)
                .child(Node.class, new NodeKey(10)).wildcardChild(NodeChild.class).build();
    ...
    public void equalsTest() {
        ...
        InstanceIdentifierBuilder<Nodes> iib1 = new InstanceIdentifierBuilderImpl<>(null, null, 31);
        InstanceIdentifierBuilder<Nodes> iib2 = new InstanceIdentifierBuilderImpl<>(null, null, 31);
        assertTrue(iib1.equals(iib2));
        assertTrue(iib2.equals(iib1));
    }
    ...
    public void legacyConversionTest() {
        final InstanceWildcard<Node> wildcard1 =
                InstanceIdentifier.builder(Nodes.class).wildcardChild(Node.class).build();
        final KeyedInstanceWildcard<NodeChild, NodeChildKey> wildcard2 =
                InstanceIdentifier.builder(Nodes.class).wildcardChild(Node.class)
                        .child(NodeChild.class, new NodeChildKey(11)).build();
        final KeyedInstanceIdentifier<Node, NodeKey> identifier1 =
                InstanceIdentifier.builder(Nodes.class).child(Node.class, new NodeKey(10)).build();

        /*here we want to check if both methods return the same InstanceIdentifier*/
        final var legacyIdentifier1 = InstanceIdentifier.toLegacy(identifier1);
        assertTrue(legacyIdentifier1 instanceof org.opendaylight.yangtools.yang.binding.KeyedInstanceIdentifier<?,?>);
        final var keyedLegacyIdentifier1 = KeyedInstanceIdentifier.toLegacy(identifier1);
        ...
        final var legacyIdentifier2 = InstanceWildcard.toLegacy(wildcard1);
        ...
        * whose last path argument is IdentifiableItem and is wildcarded. Hence, the obscure assertFalse.*/
        final var legacyIdentifier3 = InstanceWildcard.toLegacy(wildcard2);
