...
public class InstanceIdentifierTest {
    ...
    public void legacyConversionTest() {
        final var wildcard1 = InstanceIdentifier.builder(Nodes.class)
                .wildcardChild(Node.class)
                .build();
        final var wildcard2 = InstanceIdentifier.builder(Nodes.class)
                .wildcardChild(Node.class)
                .child(NodeChild.class, new NodeChildKey(11)).build();
        final var identifier1 = InstanceIdentifier.builder(Nodes.class)
                .child(Node.class, new NodeKey(10))
                .build();
