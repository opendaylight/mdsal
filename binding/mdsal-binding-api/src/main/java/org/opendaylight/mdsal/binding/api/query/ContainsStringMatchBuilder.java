...
public interface ContainsStringMatchBuilder<T extends DataObject> extends ContainsMatchBuilder<T, String> {
     ...
     */
    @NonNull ValueMatch<T> startingWith(String str);
     ...
     * @throws NullPointerException if str is null
     */
    @NonNull ValueMatch<T> endingWith(String str);
     ...
     * @throws NullPointerException if str is null
     */
    @NonNull ValueMatch<T> containing(String str);
     ...
     */
    @NonNull ValueMatch<T> matchingPattern(Pattern pattern);
}
