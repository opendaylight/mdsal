 ...
 */
public class KeyedInstanceWildcard<T extends KeyAware<K> & DataObject, K extends Key<T>> extends InstanceWildcard<T> {
    @java.io.Serial
    ...
    public interface KeyedWildcardBuilder<T extends DataObject & KeyAware<K>, K extends Key<T>> {
        /**
         ...
         */
        <N extends KeyAware<L> & ChildOf<? super T>, L extends Key<N>> @NonNull KeyedWildcardBuilder<N, L> child(
            Class<@NonNull N> listItem, L listKey);
        ...
        <C extends ChoiceIn<? super T> & DataObject, L extends Key<N>, N extends KeyAware<L> & ChildOf<? super C>>
            @NonNull KeyedWildcardBuilder<N, L> child(Class<C> caze, Class<N> listItem, L listKey);
