...
/**
 * Baseline adapter between {@link ClusteredDataTreeChangeListener} and {@link DataChangeListener}. It effectively
 * reports the first {@link DataTreeModification}'s 'data before' view and the last {@link DataTreeModification}'s
 * data after.
 */
