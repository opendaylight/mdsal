...
/**
 * Provides access to a conceptual data tree store and also provides the ability to subscribe for changes to data under
 * a given branch of the tree.
 *
...
public interface DataBroker extends BindingService, TransactionFactory, DataTreeChangeService {
     ...
     *
     * <p>When transactions are merged, {@link TransactionChain#newReadOnlyTransaction()} may actually be backed by
