...
public interface DataTreeChangeListener<T extends DataObject> extends EventListener {
     ...
     *
     * <p>
     * If there is no pre-existing data, this list will be empty.
     *
     * <p>
     ...
     *
     * @param changes List of change events, may not be null. Empty list indicates initial convergence on non-existing
     *                data.
     */
    void onDataTreeChanged(@NonNull List<DataTreeModification<T>> changes);

    // FIXME: errors
    // FIXME: initial event is clunky
}
