...
public interface MatchBuilderPath<O extends DataObject, T extends DataObject> extends Mutable {
     ...
     *
     * @param methodRef method reference to the getter method
     * @return A {@link LeafListValueMatchBuilder}
     * @throws NullPointerException if methodRef is null
     */
    @NonNull LeafListValueMatchBuilder<O, Boolean> leafList(BooleanLeafListReference<T> methodRef);
     ...
     * @throws NullPointerException if methodRef is null
     */
    @NonNull LeafListValueMatchBuilder<O, Empty> leafList(EmptyLeafListReference<T> methodRef);

    /**
     * Match an {@code string} leaf-list's value.
     *
     * @param methodRef method reference to the getter method
     * @return A {@link StringLeafListMatchBuilder}
     * @throws NullPointerException if methodRef is null
     */
    @NonNull StringLeafListMatchBuilder<O> leafList(StringLeafListReference<T> methodRef);

    /**
     * Match an {@code int8} leaf-list's value.
     *
     * @param methodRef method reference to the getter method
     * @return A {@link ComparableLeafListMatchBuilder}
     * @throws NullPointerException if methodRef is null
     */
    @NonNull ComparableLeafListMatchBuilder<O, Byte> leafList(Int8LeafListReference<T> methodRef);
     ...
     * @throws NullPointerException if methodRef is null
     */
    @NonNull ComparableLeafListMatchBuilder<O, Short> leafList(Int16LeafListReference<T> methodRef);
     ...
     * @throws NullPointerException if methodRef is null
     */
    @NonNull ComparableLeafListMatchBuilder<O, Integer> leafList(Int32LeafListReference<T> methodRef);
     ...
     * @throws NullPointerException if methodRef is null
     */
    @NonNull ComparableLeafListMatchBuilder<O, Long> leafList(Int64LeafListReference<T> methodRef);
     ...
     * @throws NullPointerException if methodRef is null
     */
    @NonNull ComparableLeafListMatchBuilder<O, Uint8> leafList(Uint8LeafListReference<T> methodRef);
     ...
     * @throws NullPointerException if methodRef is null
     */
    @NonNull ComparableLeafListMatchBuilder<O, Uint16> leafList(Uint16LeafListReference<T> methodRef);
     ...
     * @throws NullPointerException if methodRef is null
     */
    @NonNull ComparableLeafListMatchBuilder<O, Uint32> leafList(Uint32LeafListReference<T> methodRef);
     ...
     * @throws NullPointerException if methodRef is null
     */
    @NonNull ComparableLeafListMatchBuilder<O, Uint64> leafList(Uint64LeafListReference<T> methodRef);
     ...
     * @throws NullPointerException if methodRef is null
     */
    <I extends BaseIdentity> @NonNull LeafListValueMatchBuilder<O, I> leafList(
     ...
     * @throws NullPointerException if methodRef is null
     */
    <C extends TypeObject> @NonNull LeafListValueMatchBuilder<O, C> leafList(
