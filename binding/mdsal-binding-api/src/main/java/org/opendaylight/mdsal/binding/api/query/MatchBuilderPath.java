...
public interface MatchBuilderPath<O extends DataObject, T extends DataObject> extends Mutable {
     ...
     */
    @FunctionalInterface
    interface LeafListReference<P, C> extends LeafReference<P, List<C>> {
    ...
    @FunctionalInterface
    interface BooleanLeafListReference<P> extends LeafListReference<P, Boolean> {

    }

    @FunctionalInterface
    interface Decimal64LeafListReference<P> extends LeafListReference<P, BigDecimal> {

    }

    @FunctionalInterface
    interface EmptyLeafListReference<P> extends LeafListReference<P, Empty> {

    }

    @FunctionalInterface
    interface StringLeafListReference<P> extends LeafListReference<P, String> {

    }

    @FunctionalInterface
    interface Int8LeafListReference<P> extends LeafListReference<P, Byte> {

    }

    @FunctionalInterface
    interface Int16LeafListReference<P> extends LeafListReference<P, Short> {

    }

    @FunctionalInterface
    interface Int32LeafListReference<P> extends LeafListReference<P, Integer> {

    }

    @FunctionalInterface
    interface Int64LeafListReference<P> extends LeafListReference<P, Long> {

    }

    @FunctionalInterface
    interface Uint8LeafListReference<P> extends LeafListReference<P, Uint8> {

    }

    @FunctionalInterface
    interface Uint16LeafListReference<P> extends LeafListReference<P, Uint16> {

    }

    @FunctionalInterface
    interface Uint32LeafListReference<P> extends LeafListReference<P, Uint32> {

    }

    @FunctionalInterface
    interface Uint64LeafListReference<P> extends LeafListReference<P, Uint64> {

    }

    @FunctionalInterface
    interface IdentityLeafListReference<P, T extends BaseIdentity> extends LeafListReference<P, T> {

    }

    @FunctionalInterface
    interface TypeObjectLeafListReference<P, T extends TypeObject> extends LeafListReference<P, T> {
