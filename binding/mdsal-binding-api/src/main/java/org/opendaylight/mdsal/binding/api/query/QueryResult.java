...
public interface QueryResult<T extends DataObject> {
    ...
    static final class Item<T extends DataObject> implements Immutable {
        private final InstanceIdentifier<T> path;
        private final T obj;

        private Item(final InstanceIdentifier<T> path, final T obj) {
        ...
        @Override
        public int hashCode() {
            return path.hashCode() * 31 + obj.hashCode();
        }
        ...
        public boolean equals(final @Nullable Object obj) {
            ...
            return path.equals(other.path) && obj.equals(other.obj);
        }
    }
