...
public sealed interface DataObjectModification<T extends DataObject>
     ...
     */
    public sealed interface WithDataAfter<T extends DataObject> extends DataObjectModification<T>
     ...
     * A {@link DataObjectModification} after which there is the instance value available.
     */
    public sealed interface WithDataBefore<T extends DataObject> extends DataObjectModification<T>
