...
public class InstanceIdentifier<T extends DataObject>
    ...
    public static <T extends DataObject> org.opendaylight.yangtools.yang.binding.@NonNull InstanceIdentifier<T>
        toLegacy(final InstanceIdentifier<T> identifier) {
        return org.opendaylight.yangtools.yang.binding.InstanceIdentifier.unsafeOf(toLegacyPathArguments(identifier
                .pathArguments));
    }
    ...
    static <C extends ChoiceIn<?> & DataObject, T extends ChildOf<? super C> & Identifiable<I>,
        ...
        if (caseTypeOpt.isEmpty()) {
            ...
            if (arg instanceof org.opendaylight.yangtools.yang.binding.InstanceIdentifier.Item<?>) {
                return Item.of(caseTypeOpt.get(), type);
            } else if (arg instanceof org.opendaylight.yangtools.yang.binding.InstanceIdentifier.IdentifiableItem<?,?>
                identifiableItem) {
                return IdentifiableItem.of(caseTypeOpt.get(), type, (I)identifiableItem.getKey());
            }
            throw new IllegalArgumentException();
        }
    }
