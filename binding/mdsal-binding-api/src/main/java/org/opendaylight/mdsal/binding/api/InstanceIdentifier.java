...
public class InstanceIdentifier<T extends DataObject>
    ...
    private <N extends DataObject & Identifiable<K>, K extends Identifier<N>> @NonNull KeyedInstanceIdentifier<N,K>
    ...
    private <N extends DataObject & Identifiable<?>> @NonNull InstanceWildcard<N> wildcardChildIdentifier(Item<N> arg) {
     ...
     */
    public <N extends ChildOf<? super T>> @NonNull InstanceIdentifier<N> child(
    ...
    public <N extends Identifiable<K> & ChildOf<? super T>, K extends Identifier<N>>
            @NonNull KeyedInstanceIdentifier<N, K> child(final Class<@NonNull N> listItem,
            final K listKey) {
    ...
    public <N extends ChildOf<? super T> & Identifiable<?>> @NonNull InstanceWildcard<N> wildcardChild(
            final Class<@NonNull N> container) {
        return wildcardChildIdentifier(Item.of(container));
    }

    public <C extends ChoiceIn<? super T> & DataObject, N extends ChildOf<? super C> & Identifiable<?>>
    ...
    public <N extends DataObject & Augmentation<? super T> & Identifiable<?>> @NonNull InstanceWildcard<N>
        wildcardAugmentation(final Class<@NonNull N> container) {
        return wildcardChildIdentifier(Item.of(container));
    }
    ...
    public static <T extends ChildOf<? extends DataRoot> & Identifiable<?>> @NonNull WildcardBuilder<T> wildcardBuilder(
            final Class<T> container) {
        return new InstanceIdentifierBuilderImpl<T>().addWildNode(Item.of(container));
    }

    public static <C extends ChoiceIn<? extends DataRoot> & DataObject, T extends ChildOf<? super C> & Identifiable<?>>
    ...
    public static <R extends DataRoot & DataObject, T extends ChildOf<? super R> & Identifiable<?>>
    ...
    public static <R extends DataRoot & DataObject, C extends ChoiceIn<? super R> & DataObject,
            T extends ChildOf<? super C> & Identifiable<?>>
    ...
    static <N extends DataObject> @NonNull InstanceIdentifier<N> trustedCreate(final PathArgument arg,
        ...
        if (Identifiable.class.isAssignableFrom(arg.getType())) {
            ...
            return new KeyedInstanceIdentifier(arg.getType(), pathArguments, hash, key);
        }
    ...
    @SuppressWarnings("unchecked")
    static <C extends ChoiceIn<?> & DataObject, T extends ChildOf<? super C> & Identifiable<I>,
            I extends Identifier<T>> org.opendaylight.yangtools.yang.binding.InstanceIdentifier.PathArgument
        ...
        if (arg instanceof Item<?> item) {
            ...
            final I key = (I)identifiableItem.getKey();
    ...
    @SuppressWarnings("unchecked")
    static <C extends ChoiceIn<?> & DataObject, T extends ChildOf<? super C> & Identifiable<I>,
            I extends Identifier<T>> PathArgument ofLegacyPathArgument(final
            org.opendaylight.yangtools.yang.binding.InstanceIdentifier.PathArgument arg) {
        final Class<T> type = (Class<T>)arg.getType();
        ...
        if (caseTypeOpt.isEmpty()) {
            if (arg instanceof org.opendaylight.yangtools.yang.binding.InstanceIdentifier.Item<?>) {
                return Item.of(type);
                    ...
                    identifiableItem) {
                return IdentifiableItem.of(type, (I)identifiableItem.getKey());
            }
            throw new IllegalArgumentException();
        } else {
            if (arg instanceof org.opendaylight.yangtools.yang.binding.InstanceIdentifier.Item<?>) {
                ...
                identifiableItem) {
                return IdentifiableItem.of(caseTypeOpt.orElseThrow(), type, (I)identifiableItem.getKey());
            }
            throw new IllegalArgumentException();
        }
    }
