...
public class KeyedInstanceIdentifier<T extends Identifiable<K> & DataObject, K extends Identifier<T>>
    ...
    public static <T extends Identifiable<K> & DataObject, K extends Identifier<T>> KeyedInstanceIdentifier<T,K>
        ofLegacy(final org.opendaylight.yangtools.yang.binding.KeyedInstanceIdentifier<T,K> kii) {
    ...
    public static <T extends Identifiable<K> & DataObject, K extends Identifier<T>>
        org.opendaylight.yangtools.yang.binding.KeyedInstanceIdentifier<T,K> toLegacy(final
        ...
        final org.opendaylight.yangtools.yang.binding.InstanceIdentifier result =
                org.opendaylight.yangtools.yang.binding.InstanceIdentifier.unsafeOf(InstanceIdentifier
                        .toLegacyPathArguments(kii.getPathArguments()));
