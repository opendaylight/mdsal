...
public interface ManagedTransactionFactory {
     ...
     *
     * @return the {@link ListenableFuture} returned by {@link ReadWriteTransaction#commit()},
     ...
     * @return the {@link ListenableFuture} returned by {@link WriteTransaction#commit()},
     *     or a failed future with an application specific exception (not from submit())
     */
    @CheckReturnValue
    <D extends Datastore, E extends Exception>
