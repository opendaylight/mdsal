...
import org.opendaylight.mdsal.binding.api.ds.WriteOperations;
 ...
 * @see WriteOperations
 */
public interface TypedWriteTransaction<D extends Datastore> extends Transaction, WriteOperations<D> {
