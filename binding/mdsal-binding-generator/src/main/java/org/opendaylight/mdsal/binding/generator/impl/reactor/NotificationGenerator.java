 ...
 */
final class NotificationGenerator extends CompositeSchemaTreeGenerator<NotificationEffectiveStatement,
        NotificationRuntimeType, NotificationGenerator> {
    ...
    @Override
    NotificationRuntimeType createRuntimeType(final GeneratedType type,
            final Map<RuntimeType, EffectiveStatement<?, ?>> children) {
        return new DefaultNotificationRuntimeType(type, statement(), children);
    }
