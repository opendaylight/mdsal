...
final class ReferencedListRuntimeType extends DefaultListRuntimeType implements ReferencedAugmentableRuntimeType {
    private final @NonNull List<AugmentRuntimeType> referencingAugments;

    ReferencedListRuntimeType(final GeneratedType bindingType, final ListEffectiveStatement statement,
        ...
        super(bindingType, statement, children, augments, keyType);
