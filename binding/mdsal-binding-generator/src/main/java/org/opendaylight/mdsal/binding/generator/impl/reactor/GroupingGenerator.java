...
final class GroupingGenerator extends AbstractCompositeGenerator<GroupingEffectiveStatement, GroupingRuntimeType> {
    ...
    @Override
    GroupingRuntimeType createExternalRuntimeType(final GeneratedType type, final List<RuntimeType> children,
    ...
    @Override
    GroupingRuntimeType createInternalRuntimeType(final GroupingEffectiveStatement statement, final GeneratedType type,
            final List<RuntimeType> children,  final List<AugmentRuntimeType> augments) {
        // Groupings are not schema tree statements, they should never have internal references
