...
public abstract class AbstractExplicitGenerator<T extends EffectiveStatement<?, ?>, R extends RuntimeType>
        extends Generator implements CopyableNode, StatementRepresentation<T> {
    ...
    abstract @NonNull R rebaseRuntimeType(@NonNull R type, @NonNull T statement);
