...
public abstract class AbstractExplicitGenerator<S extends EffectiveStatement<?, ?>, R extends RuntimeType>
     ...
     */
    final @Nullable R createInternalRuntimeType(final @NonNull S stmt) {
        ...
        do {
            ...
            if (type != null) {
                return createInternalRuntimeType(stmt, type);
            }
    ...
    abstract @NonNull R createInternalRuntimeType(@NonNull S statement, @NonNull Type type);
