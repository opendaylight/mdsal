 ...
 */
final class ListGenerator extends CompositeSchemaTreeGenerator<ListEffectiveStatement, ListRuntimeType, ListGenerator> {
    ...
    @Override
    ListRuntimeType createRuntimeType(final GeneratedType type,
            final Map<RuntimeType, EffectiveStatement<?, ?>> children) {
        return new DefaultListRuntimeType(type, statement(), children);
    }
