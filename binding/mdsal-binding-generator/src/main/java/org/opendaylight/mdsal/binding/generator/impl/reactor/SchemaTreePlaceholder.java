...
final class SchemaTreePlaceholder<S extends SchemaTreeEffectiveStatement<?>,
    ...
    void setGenerator(final AbstractExplicitGenerator<?> generator) {
        verify(this.generator == null, "Attempted to set generator for %s", this);
        this.generator = generatorType.cast(requireNonNull(generator));
    }
}
