...
public abstract class Generator implements Iterable<Generator> {
    ...
    public final @Nullable WithStatement archetype() {
    ...
    @NonNull WithStatement getGeneratedType() {
        return verifyNotNull(tryGeneratedType(), "No type generated for %s", this);
    }

    final @Nullable WithStatement tryGeneratedType() {
        ensureType();
        return result.archetype();
    }

    final @Nullable WithStatement enclosedType() {
        ensureType();
     ...
     */
    abstract @NonNull WithStatement createTypeImpl();
