...
final class LeafGenerator extends AbstractTypeAwareGenerator<LeafEffectiveStatement, LeafGenerator> {
    ...
    @Override
    public LeafRuntimeType toRuntimeType(final TypeBuilderFactory builderFactory) {
        return new DefaultLeafRuntimeType(getGeneratedType(builderFactory), statement());
    }
}
