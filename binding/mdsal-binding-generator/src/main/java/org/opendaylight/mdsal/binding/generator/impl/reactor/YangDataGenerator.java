...
final class YangDataGenerator extends AbstractCompositeGenerator<YangDataEffectiveStatement, YangDataRuntimeType> {
    ...
    Member createMember(final CollisionDomain domain) {
        ...
        final ClassNamingStrategy namingStrategy;
        if (identifier != null) {
            namingStrategy = new CamelCaseNamingStrategy(namespace(), identifier);
        } else {
            namingStrategy = new YangDataNamingStrategy(namespace(), templateName, "yang-data");
        }
