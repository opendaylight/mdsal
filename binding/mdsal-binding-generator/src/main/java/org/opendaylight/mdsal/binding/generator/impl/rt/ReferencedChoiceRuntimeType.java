...
final class ReferencedChoiceRuntimeType extends DefaultChoiceRuntimeType
        implements ReferencedAugmentableRuntimeType {
    private final @NonNull List<AugmentRuntimeType> referencingAugments;

    ReferencedChoiceRuntimeType(final GeneratedType bindingType, final ChoiceEffectiveStatement statement,
