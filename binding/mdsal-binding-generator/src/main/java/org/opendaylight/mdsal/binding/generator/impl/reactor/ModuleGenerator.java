...
public final class ModuleGenerator extends AbstractCompositeGenerator<ModuleEffectiveStatement, ModuleRuntimeType> {
     ...
     * actually produces one of <em>secondary</em> members, more precisely the {@link Naming#DATA_ROOT_SUFFIX}
    ...
    private @NonNull String rootPackageName() {
        ...
        namespace = Naming.COLON_SLASH_SLASH.matcher(namespace).replaceAll(Naming.QUOTED_DOT);
