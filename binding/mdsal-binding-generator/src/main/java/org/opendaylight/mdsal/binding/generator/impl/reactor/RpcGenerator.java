 ...
 */
final class RpcGenerator extends CompositeSchemaTreeGenerator<RpcEffectiveStatement, RpcRuntimeType, RpcGenerator> {
    ...
    @Override
    RpcRuntimeType toRuntimeType(final GeneratedType type, final Map<RuntimeType, EffectiveStatement<?, ?>> children) {
        throw new UnsupportedOperationException();
    }
