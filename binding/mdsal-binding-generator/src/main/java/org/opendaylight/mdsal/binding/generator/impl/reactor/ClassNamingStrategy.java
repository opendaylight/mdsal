 ...
 */
@NonNullByDefault
abstract sealed class ClassNamingStrategy implements Immutable permits CamelCaseNamingStrategy,
    ForwardingClassNamingStrategy, ModuleNamingStrategy {
    /**
     ...
     */
    abstract AbstractQName nodeIdentifier();
    ...
    abstract StatementNamespace namespace();
