...
abstract class OperationContainerGenerator<S extends DataTreeEffectiveStatement<?>, R extends CompositeRuntimeType,
        G extends OperationContainerGenerator<S, R, G>> extends CompositeSchemaTreeGenerator<S, R, G> {
...
//                builder.setSchemaPath(schemaNode.getPath());
    ...
    @Override
    abstract ContainerLikeRuntimeType<?, ?> toRuntimeType(GeneratedType type,
        Map<RuntimeType, EffectiveStatement<?, ?>> children);
}
