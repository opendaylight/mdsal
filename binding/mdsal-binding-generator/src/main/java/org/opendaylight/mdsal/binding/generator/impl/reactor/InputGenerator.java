 ...
 */
class InputGenerator extends OperationContainerGenerator<InputEffectiveStatement, InputRuntimeType, InputGenerator> {
    ...
    @Override
    final InputRuntimeType createRuntimeType(final GeneratedType type,
            final Map<RuntimeType, EffectiveStatement<?, ?>> children) {
        return new DefaultInputRuntimeType(type, statement(), children);
    }
}
