 ...
 */
final class CaseGenerator extends CompositeSchemaTreeGenerator<CaseEffectiveStatement, CaseRuntimeType, CaseGenerator> {
    ...
    @Override
    CaseRuntimeType createRuntimeType(final GeneratedType type,
            final Map<RuntimeType, EffectiveStatement<?, ?>> children, final List<AugmentRuntimeType> augments) {
        return new DefaultCaseRuntimeType(type, statement(), children, augments);
    }
}
