...
final class ReferencedCaseRuntimeType extends DefaultCaseRuntimeType implements ReferencedAugmentableRuntimeType {
    private final @NonNull List<AugmentRuntimeType> referencingAugments;

    ReferencedCaseRuntimeType(final GeneratedType bindingType, final CaseEffectiveStatement statement,
