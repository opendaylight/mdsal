...
public final class DefaultBindingRuntimeTypes implements BindingRuntimeTypes {
    ...
    private final ImmutableSetMultimap<JavaTypeName, RuntimeType> groupingToInstantiation;
    ...
    public DefaultBindingRuntimeTypes(final EffectiveModelContext context,
            ...
            final SetMultimap<JavaTypeName, RuntimeType> groupingToInstantiation) {
    ...
    @Override
    public Set<RuntimeType> allGroupingInstance(final JavaTypeName groupingType) {
