...
final class ReferencedInputRuntimeType extends DefaultInputRuntimeType implements ReferencedAugmentableRuntimeType {
    private final @NonNull List<AugmentRuntimeType> referencingAugments;

    ReferencedInputRuntimeType(final GeneratedType bindingType, final InputEffectiveStatement statement,
