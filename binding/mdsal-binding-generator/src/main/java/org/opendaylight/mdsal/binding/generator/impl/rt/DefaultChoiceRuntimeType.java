...
@Beta
public final class DefaultChoiceRuntimeType extends AbstractAugmentableRuntimeType<ChoiceEffectiveStatement>
    ...
    public DefaultChoiceRuntimeType(final GeneratedType bindingType, final ChoiceEffectiveStatement statement,
        ...
        super(bindingType, statement, children, List.of());
    }
