...
public final class DefaultChoiceRuntimeType extends AbstractCompositeRuntimeType<ChoiceEffectiveStatement>
    ...
    public CaseRuntimeType bindingCaseChild(final JavaTypeName typeName) {
        ...
        return child instanceof CaseRuntimeType ? validateCaseChild((CaseRuntimeType) child) : null;
    }

    private @Nullable CaseRuntimeType validateCaseChild(final CaseRuntimeType child) {
        // FIXME: Make sure that if there are multiple augmentations of same named case, with same structure we treat it
        //        as equals this is due property of Binding specification and copy builders that user may be unaware
        //        that he is using incorrect case which was generated for choice inside grouping.
