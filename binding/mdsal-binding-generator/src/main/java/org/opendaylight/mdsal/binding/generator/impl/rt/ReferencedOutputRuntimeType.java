...
final class ReferencedOutputRuntimeType extends DefaultOutputRuntimeType implements ReferencedAugmentableRuntimeType {
    private final @NonNull List<AugmentRuntimeType> referencingAugments;

    ReferencedOutputRuntimeType(final GeneratedType bindingType, final OutputEffectiveStatement statement,
