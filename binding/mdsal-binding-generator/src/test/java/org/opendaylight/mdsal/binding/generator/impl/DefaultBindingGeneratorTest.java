...
public class DefaultBindingGeneratorTest {
    ...
    public void javaTypeForSchemaDefinitionLeafrefToEnumTypeTest() {
        ...
        assertEquals("org.opendaylight.yang.gen.v1.urn.opendaylight.org.test.type.provider.model.rev140912.Foo."
                + "ResolveDirectUseOfEnum", bEnumType.getFullyQualifiedName());
        ...
        assertEquals(
            "org.opendaylight.yang.gen.v1.urn.opendaylight.org.test.type.provider.model.rev140912.Foo.ListOfEnums",
            enumsTypeArgs[0].getFullyQualifiedName());
    }
}
