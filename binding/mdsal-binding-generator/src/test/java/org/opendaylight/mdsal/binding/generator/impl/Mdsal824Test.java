...
public class Mdsal824Test {
    ...
    public void testRunTimeTypes() {
        ...
        assertEquals(JavaTypeName.create("org.opendaylight.yang.gen.v1.foo.norev.act.grp.foo", "Input"),
        ...
        assertEquals(JavaTypeName.create("org.opendaylight.yang.gen.v1.foo.norev.act.grp.foo", "Output"),
