...
public class BindingReflectionsTest {
    ...
    public void testBindingWithDummyObject() throws Exception {
        ...
        ChildOf childOf = mock(FooChild.class);
    ...
    public void testPrivateConstructor() throws Throwable {
        ...
        Constructor constructor = BindingReflections.class.getDeclaredConstructor();
...
final class TestImplementation extends BaseIdentity implements Augmentation<TestImplementation>, RpcService {
    public static QName QNAME = QName.create("test");
