...
public class RpcServiceInvokerTest {
    ...
    public void fromTest() throws Exception {
        ...
        assertNotNull(RpcServiceInvoker.from(ImmutableMap.of(
            QName.create(QNameModule.create(URI.create("testURI"), Revision.valueOf("2017-10-26")),"test"), method,
            QName.create(QNameModule.create(URI.create("testURI2"), Revision.valueOf("2017-10-26")),"test"), method)));
        assertNotNull(RpcServiceInvoker.from(ImmutableMap.of(
            QName.create(QNameModule.create(URI.create("testURI"), Revision.valueOf("2017-10-26")), "test"), method)));
    }
