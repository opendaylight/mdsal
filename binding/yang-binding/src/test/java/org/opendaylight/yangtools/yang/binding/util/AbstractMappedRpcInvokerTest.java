...
import org.opendaylight.yangtools.yang.binding.util.AbstractMappedRpcInvokerTest.Crate;
...
public class AbstractMappedRpcInvokerTest {
    ...
    public void invokeRpcTest() throws Exception {
        ...
        final Crate crateWithoutInput =
                (Crate) testRpcInvokerWithoutInput.invokeRpc(rpcService, QName.create("tstWithoutInput"), null).get();
        assertEquals(TestRpcService.methodWithoutInput(rpcService).get().getRpcService(), crateWithoutInput.getRpcService());
        ...
        final Crate crateWithInput =
                (Crate) testRpcInvokerWithInput.invokeRpc(rpcService, QName.create("tstWithInput"), dataObject).get();
        assertEquals(TestRpcService.methodWithInput(rpcService, dataObject).get().getRpcService(), crateWithInput.getRpcService());
...
class TestRpcService implements RpcService {
