 ...
 */
@Beta
public interface Annotation<T> extends BindingObject {
    /**
     * Return the value of this annotation.
     *
     * @return The value of this annotation.
     */
    // TODO: separate this method out to a dedicated interface, so its specification can be shared with simple
    //       non-union TypeObjects. Why unions do not define a getValue() needs to be investigated.
    @NonNull T getValue();
}
