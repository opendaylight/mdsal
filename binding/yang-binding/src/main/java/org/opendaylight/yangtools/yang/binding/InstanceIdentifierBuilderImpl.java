...
final class InstanceIdentifierBuilderImpl<T extends DataObject> implements InstanceIdentifierBuilder<T> {
    ...
    @SuppressWarnings("unchecked")
    <N extends DataObject> InstanceIdentifierBuilderImpl<N> addNode(final PathArgument arg) {
        this.arg = arg;
    ...
    <N extends DataObject> InstanceIdentifierBuilderImpl<N> addWildNode(final PathArgument arg) {
