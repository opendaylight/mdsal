...
final class KeyedInstanceIdentifierBuilderImpl<T extends DataObject & Identifiable<K>, K extends Identifier<T>>
        extends InstanceIdentifierBuilderImpl<T> implements KeyedBuilder<T, K> {
