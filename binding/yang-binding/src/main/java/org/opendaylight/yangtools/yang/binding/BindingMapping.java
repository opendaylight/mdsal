...
public final class BindingMapping {
    ...
    public static String getRootPackageName(final QNameModule module) {
        ...
        if (optRev.isPresent()) {
            ...
            packageNameBuilder.append(rev.substring(2, 4)).append(rev.substring(5, 7)).append(rev.substring(9));
        } else {
            // Backwards compatibility: yang parser used to fill 1970-01-01 as the revision when the module did not
            // contain a revision statement.
            packageNameBuilder.append("700101");
        }
