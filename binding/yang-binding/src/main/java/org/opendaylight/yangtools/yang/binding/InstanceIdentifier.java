...
public sealed class InstanceIdentifier<T extends DataObject>
    ...
    abstract static sealed class AbstractPathArgument<T extends DataObject>
        ...
        @Override
        public final int hashCode() {
            return Objects.hash(type, caseType(), getKey());
        }

        @Override
        public final boolean equals(final Object obj) {
            return this == obj || obj instanceof AbstractPathArgument<?> other && type.equals(other.type)
                && Objects.equals(getKey(), other.getKey()) && Objects.equals(caseType(), other.caseType());
        }
