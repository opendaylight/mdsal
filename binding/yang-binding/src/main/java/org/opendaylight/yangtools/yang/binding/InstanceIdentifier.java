...
public class InstanceIdentifier<T extends DataObject>
    ...
    public abstract static sealed class Builder<T extends DataObject> {
         ...
         * @throws NullPointerException if {@code container} is null
         */
        public final <N extends DataObject & Augmentation<? super T>> RegularBuilder<N> augmentation(
         ...
         * @throws NullPointerException if {@code container} is null
         */
        public final <N extends ChildOf<? super T>> RegularBuilder<N> child(final Class<N> container) {
         ...
         * @throws NullPointerException if {@code container} is null
         */
        public final <C extends ChoiceIn<? super T> & DataObject, N extends ChildOf<? super C>> RegularBuilder<N> child(
