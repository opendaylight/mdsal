...
public class InstanceIdentifier<T extends DataObject> implements Path<InstanceIdentifier<? extends DataObject>>,
    ...
    public interface PathArgument extends Comparable<PathArgument> {
        ...
        static <C extends ChoiceIn<?> & DataObject, T extends ChildOf<? super C>> PathArgument of(
    ...
    public interface KeyedPathArgument extends PathArgument {
        ...
        static <C extends ChoiceIn<?> & DataObject, T extends ChildOf<? super C> & Identifiable<K>,
                K extends Identifier<T>> KeyedPathArgument of(final Class<C> caseType, final Class<T> type,
                        final K key) {
     ...
     *
     * @param <T> Item type
     * @deprecated Use {@link PathArgument} instead and its static methods {@link PathArgument#of(Class)} and
     *             {@link PathArgument#of(Class, Class)}.
     */
    @Deprecated
     ...
     *
     * @deprecated Use {@link KeyedPathArgument} instead and its static methods
     *             {@link KeyedPathArgument#of(Class, Identifier)} and
     *             {@link KeyedPathArgument#of(Class, Class, Identifier)}.
     */
    @Deprecated
