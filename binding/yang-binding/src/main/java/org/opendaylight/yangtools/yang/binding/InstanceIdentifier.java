...
public class InstanceIdentifier<T extends DataObject>
    ...
    public static <R extends DataRoot & DataObject, T extends ChildOf<? super R>> @NonNull
            WildcardedInstanceIdentifierBuilder<T> wildcardBuilderOfInherited(final Class<R> root,
            final Class<T> container) {
        // FIXME: we are losing root identity, hence namespaces may not work correctly
