...
public final class CodeHelpers {
    ...
    /**
     * Bootstrap a singleton value for an {code identity} interface.
     *
     * @param <T> Identity type
     * @param supplier Bootstrap supplier
     * @return A singleton value
     */
    public static <@NonNull T extends BaseIdentity> T identityValue(final Supplier<T> supplier) {
        return verifyNotNull(supplier.get());
    }
}
