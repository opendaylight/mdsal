...
public final class CodeHelpers {
    ...
    public static <T> @Nullable T checkedFieldCast(final @NonNull Class<T> requiredClass,
            final @NonNull String fieldName, final @Nullable Object obj) {
        try {
            return requiredClass.cast(requireNonNull(obj));
    ...
    public static <T> @Nullable List<T> checkListFieldCast(final @NonNull Class<?> requiredClass,
        ...
        if (list != null) {
            try {
                ...
                throw new IllegalArgumentException("Invalid input list item for property \"" + fieldName + "\"", e);
            }
        }
        return (List<T>) list;
    }
