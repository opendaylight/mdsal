...
public final class CodeHelpers {
     ...
     * @throws NullPointerException if {@code requiredClass} or {@code fieldName} is null
     */
    public static <T extends BaseIdentity> @Nullable List<? extends Class<T>> checkListFieldCastIdentity(
        ...
        return (List<? extends Class<T>>) list;
    }
     ...
     */
    @SuppressWarnings("unchecked")
    public static <T extends BaseIdentity> @Nullable Set<? extends Class<T>> checkSetFieldCastIdentity(
            final @NonNull Class<T> requiredClass, final @NonNull String fieldName, final @Nullable Set<?> list) {
        checkCollectionFieldIdentity(requiredClass, fieldName, list);
        return (Set<? extends Class<T>>) list;
    }
