 ...
 */
// TODO: when we add support for RFC8791 YANG Data Structure Extensions, these should be built on top of this
//       construct, which is to say the hypothetical YangStructure interface needs to extend this interface and bring
//       Augmentable into the picture -- augment-structure maps directly to 'augment' semantics, I think.
//       On the other hand, users of YangData may assume the lack of augmentations, which would warrant creating
//       a completely separate YangStructure hierarchy of BindingObject, DataContainer and Augmentable
public non-sealed interface YangData<T extends YangData<T>> extends BindingObject, DataContainer {
    @Override
    Class<T> implementedInterface();

    // FIXME: @NonNull yang.common.YangDataName name();
}
