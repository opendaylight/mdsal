 ...
 */
package org.opendaylight.mdsal.binding.dom.codec.separate.merge.loader;
...
public abstract class CodecClassLoader extends ClassLoader {
    ...
    static {
        final String dir = System.getProperty("org.opendaylight.mdsal.binding.dom.codec.separate.merge.loader.bytecodeDumpDirectory");
