...
import static org.opendaylight.mdsal.binding.dom.codec.merge.impl.ByteBuddyUtils.getField;
import static org.opendaylight.mdsal.binding.dom.codec.merge.impl.ByteBuddyUtils.invokeMethod;
...
import org.opendaylight.mdsal.binding.dom.codec.merge.loader.CodecClassLoader.ClassGenerator;
import org.opendaylight.mdsal.binding.dom.codec.merge.loader.CodecClassLoader.GeneratorResult;
...
final class DataObjectStreamerGenerator<T extends DataObjectStreamer<?>> implements ClassGenerator<T> {
    ...
    private DataObjectStreamerGenerator(final NodeCodecContext.CodecContextFactory registry, final GeneratedType genType,
    ...
    static Class<? extends DataObjectStreamer<?>> generateStreamer(final CodecClassLoader loader,
                                                                   final NodeCodecContext.CodecContextFactory registry, final Class<?> type) {
