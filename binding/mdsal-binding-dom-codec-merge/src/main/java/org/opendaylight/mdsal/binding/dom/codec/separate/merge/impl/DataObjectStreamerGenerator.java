...
import static org.opendaylight.mdsal.binding.dom.codec.separate.merge.impl.ByteBuddyUtils.getField;
import static org.opendaylight.mdsal.binding.dom.codec.separate.merge.impl.ByteBuddyUtils.invokeMethod;
...
import org.opendaylight.mdsal.binding.dom.codec.separate.merge.impl.NodeCodecContext.CodecContextFactory;
import org.opendaylight.mdsal.binding.dom.codec.separate.merge.loader.CodecClassLoader;
import org.opendaylight.mdsal.binding.dom.codec.separate.merge.loader.CodecClassLoader.ClassGenerator;
import org.opendaylight.mdsal.binding.dom.codec.separate.merge.loader.CodecClassLoader.GeneratorResult;
...
final class DataObjectStreamerGenerator<T extends DataObjectStreamer<?>> implements ClassGenerator<T> {
    ...
    private static final StackManipulation START_AUGMENTATION_NODE = ByteBuddyUtils.invokeMethod(BindingStreamEventWriter.class,
        "startAugmentationNode", Class.class);
    private static final StackManipulation START_CASE = ByteBuddyUtils.invokeMethod(BindingStreamEventWriter.class,
        "startCase", Class.class, int.class);
    private static final StackManipulation START_CONTAINER_NODE = ByteBuddyUtils.invokeMethod(BindingStreamEventWriter.class,
        "startContainerNode", Class.class, int.class);
    private static final StackManipulation END_NODE = ByteBuddyUtils.invokeMethod(BindingStreamEventWriter.class,
        "endNode");
    ...
    private static final StackManipulation START_MAP_ENTRY_NODE = new StackManipulation.Compound(
        OBJ,
        ByteBuddyUtils.invokeMethod(Identifiable.class, "key"),
        UNKNOWN_SIZE,
        ByteBuddyUtils.invokeMethod(BindingStreamEventWriter.class, "startMapEntryNode", Identifier.class, int.class));
    ...
    private static final StackManipulation START_UNKEYED_LIST_ITEM = new StackManipulation.Compound(
        UNKNOWN_SIZE,
        ByteBuddyUtils.invokeMethod(BindingStreamEventWriter.class, "startUnkeyedListItem", int.class));

    private static final StackManipulation STREAM_ANYDATA = ByteBuddyUtils.invokeMethod(DataObjectStreamer.class,
        "streamAnydata", BindingStreamEventWriter.class, String.class, Object.class);
    private static final StackManipulation STREAM_ANYXML = ByteBuddyUtils.invokeMethod(DataObjectStreamer.class,
        "streamAnyxml", BindingStreamEventWriter.class, String.class, Object.class);
    private static final StackManipulation STREAM_CHOICE = ByteBuddyUtils.invokeMethod(DataObjectStreamer.class,
        "streamChoice", Class.class, DataObjectSerializerRegistry.class, BindingStreamEventWriter.class,
        DataContainer.class);
    private static final StackManipulation STREAM_CONTAINER = ByteBuddyUtils.invokeMethod(DataObjectStreamer.class,
        "streamContainer", DataObjectStreamer.class, DataObjectSerializerRegistry.class, BindingStreamEventWriter.class,
        DataObject.class);
    private static final StackManipulation STREAM_LEAF = ByteBuddyUtils.invokeMethod(DataObjectStreamer.class,
        "streamLeaf", BindingStreamEventWriter.class, String.class, Object.class);
    private static final StackManipulation STREAM_LEAF_LIST = ByteBuddyUtils.invokeMethod(DataObjectStreamer.class,
        "streamLeafList",
        BindingStreamEventWriter.class, String.class, List.class);
    private static final StackManipulation STREAM_ORDERED_LEAF_LIST = ByteBuddyUtils.invokeMethod(DataObjectStreamer.class,
        "streamOrderedLeafList", BindingStreamEventWriter.class, String.class, List.class);
    private static final StackManipulation STREAM_LIST = ByteBuddyUtils.invokeMethod(DataObjectStreamer.class,
    ...
    private static final StackManipulation STREAM_MAP = ByteBuddyUtils.invokeMethod(DataObjectStreamer.class,
    ...
    private static final StackManipulation STREAM_ORDERED_MAP = ByteBuddyUtils.invokeMethod(DataObjectStreamer.class,
    ...
    private static final StackManipulation STREAM_AUGMENTATIONS = new StackManipulation.Compound(
        ...
        STREAM,
        OBJ,
        ByteBuddyUtils.invokeMethod(DataObjectStreamer.class, "streamAugmentations", DataObjectSerializerRegistry.class,
    ...
    private static ChildStream choiceChildStream(final Method getter) {
        ...
        return new ChildStream(
            ...
            STREAM,
            OBJ,
            ByteBuddyUtils.invokeMethod(getter),
            STREAM_CHOICE);
    }
    ...
    private enum InitializeInstanceField implements ByteCodeAppender {
        ...
        public Size apply(final MethodVisitor methodVisitor, final Context implementationContext,
            ...
            StackManipulation.Size operandStackSize = new StackManipulation.Compound(
                ...
                ByteBuddyUtils.putField(instrumentedType, INSTANCE_FIELD))
