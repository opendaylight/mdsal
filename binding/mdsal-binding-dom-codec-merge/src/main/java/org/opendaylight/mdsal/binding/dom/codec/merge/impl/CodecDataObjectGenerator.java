...
abstract class CodecDataObjectGenerator<T extends CodecDataObject<?>> implements ClassGenerator<T> {
    ...
    private static Implementation codecHashCode(final Class<?> bindingInterface) {
        return new Implementation.Simple(
            ...
            ByteBuddyUtils.THIS,
            ByteBuddyUtils.invokeMethod(bindingInterface, BindingMapping.BINDING_HASHCODE_NAME, bindingInterface),
    ...
    private static Implementation codecEquals(final Class<?> bindingInterface) {
        return new Implementation.Simple(
            ...
            ByteBuddyUtils.THIS,
            FIRST_ARG_REF,
            ByteBuddyUtils.invokeMethod(bindingInterface, BindingMapping.BINDING_EQUALS_NAME, bindingInterface, Object.class),
            MethodReturn.INTEGER);
    }
    ...
    private static Implementation toString(final Class<?> bindingInterface) {
        return new Implementation.Simple(
            ...
            ByteBuddyUtils.THIS,
            ByteBuddyUtils.invokeMethod(bindingInterface, BindingMapping.BINDING_TO_STRING_NAME, bindingInterface),
    ...
    private abstract static class AbstractMethodImplementation implements Implementation {
        ...
        private static final StackManipulation LOOKUP = ByteBuddyUtils.invokeMethod(MethodHandles.class, "lookup");
        private static final StackManipulation FIND_VAR_HANDLE = ByteBuddyUtils.invokeMethod(Lookup.class,
        ...
        public InstrumentedType prepare(final InstrumentedType instrumentedType) {
            ...
            return tmp.withInitializer(new ByteCodeAppender.Simple(
                ...
                OBJECT_CLASS,
                FIND_VAR_HANDLE,
                ByteBuddyUtils.putField(tmp, handleName)));
        }
    }

    private static final class KeyMethodImplementation extends AbstractMethodImplementation {
        private static final StackManipulation CODEC_KEY = ByteBuddyUtils.invokeMethod(CodecDataObject.class,
        ...
        public ByteCodeAppender appender(final Target implementationTarget) {
            return new ByteCodeAppender.Simple(
                ...
                ByteBuddyUtils.THIS,
                ByteBuddyUtils.getField(implementationTarget.getInstrumentedType(), handleName),
                CODEC_KEY,
    ...
    private static final class SimpleGetterMethodImplementation extends AbstractMethodImplementation {
        private static final StackManipulation CODEC_MEMBER = ByteBuddyUtils.invokeMethod(CodecDataObject.class,
            "codecMember", VarHandle.class, String.class);
        private static final StackManipulation BRIDGE_RESOLVE = ByteBuddyUtils.invokeMethod(ClassGeneratorBridge.class,
        ...
        public InstrumentedType prepare(final InstrumentedType instrumentedType) {
            ...
            return tmp.withInitializer(new ByteCodeAppender.Simple(
                ...
                new TextConstant(methodName),
                BRIDGE_RESOLVE,
                ByteBuddyUtils.putField(tmp, stringName)));
        }
        ...
        public ByteCodeAppender appender(final Target implementationTarget) {
            ...
            return new ByteCodeAppender.Simple(
                ...
                ByteBuddyUtils.THIS,
                ByteBuddyUtils.getField(instrumentedType, handleName),
                ByteBuddyUtils.getField(instrumentedType, stringName),
                CODEC_MEMBER,
                TypeCasting.to(retType),
                MethodReturn.REFERENCE);
        }
    ...
    private static final class SupplierGetterMethodImplementation extends AbstractMethodImplementation {
        ...
        public InstrumentedType prepare(final InstrumentedType instrumentedType) {
            ...
            return tmp.withInitializer(new ByteCodeAppender.Simple(
                ...
                new TextConstant(methodName),
                BRIDGE_RESOLVE,
                ByteBuddyUtils.putField(tmp, contextName)));
        }
        ...
        public ByteCodeAppender appender(final Target implementationTarget) {
            ...
            return new ByteCodeAppender.Simple(
                ...
                ByteBuddyUtils.THIS,
                ByteBuddyUtils.getField(instrumentedType, handleName),
                ByteBuddyUtils.getField(instrumentedType, contextName),
                CODEC_MEMBER,
                TypeCasting.to(retType),
                MethodReturn.REFERENCE);
        }
