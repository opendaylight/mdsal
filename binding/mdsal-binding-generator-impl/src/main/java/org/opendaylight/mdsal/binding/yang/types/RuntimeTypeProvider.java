...
public final class RuntimeTypeProvider extends AbstractTypeProvider {
    ...
    @Override
    public GeneratedTOBuilder newGeneratedTOBuilder(final TypeName identifier) {
        return new RuntimeGeneratedTOBuilder(identifier);
    }

    @Override
    public GeneratedTypeBuilder newGeneratedTypeBuilder(final TypeName identifier) {
        return new RuntimeGeneratedTypeBuilder(identifier);
    }

    @Override
    public AbstractEnumerationBuilder newEnumerationBuilder(final TypeName identifier) {
