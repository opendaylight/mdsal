...
//        builder.addImplementsType(implementedType(builderFactory));
        currentModule().addQNameConstant(builder, statement().argument().getLocalName());
...
//        final GeneratedType input = getChild(this, InputEffectiveStatement.class).getGeneratedType(builderFactory);
//        final GeneratedType output = getChild(this, OutputEffectiveStatement.class).getGeneratedType(builderFactory);
//
