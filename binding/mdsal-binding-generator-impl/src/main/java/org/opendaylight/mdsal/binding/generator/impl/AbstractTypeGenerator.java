...
abstract class AbstractTypeGenerator {
    ...
    private Type createRpcContainer(final ModuleContext context, final String rpcName, final RpcDefinition rpc,
        ...
        final GeneratedTypeBuilder outType = addRawInterfaceDefinition(context, schema, rpcName);
    ...
    private GeneratedTypeBuilder addRawAugmentGenTypeDefinition(final ModuleContext context,
        ...
        final GeneratedTypeBuilder augTypeBuilder = typeProvider.newGeneratedTypeBuilder(
            TypeName.create(augmentPackageName, augTypeName));
    ...
    private GeneratedTOBuilder createUnionBuilder(final GeneratedTOBuilder genTOBuilder,
        ...
        // FIXME: TypeName could be giving us this as a utility method
        Optional<TypeName> outerClass = genTOBuilder.getIdentifier().immediatelyEnclosingClass();
        if (outerClass.isPresent()) {
            final Deque<String> enclosingPath = new ArrayDeque<>();
            do {
                final TypeName outerName = outerClass.get();
        ...
        final GeneratedTOBuilder unionBuilder = typeProvider.newGeneratedTOBuilder(
            TypeName.create(typeBuilder.getPackageName(), sb.toString()));
    ...
    private GeneratedTypeBuilder addDefaultInterfaceDefinition(final String packageName, final SchemaNode schemaNode,
        ...
        final GeneratedTypeBuilder it = addRawInterfaceDefinition(
            TypeName.create(packageName, BindingMapping.getClassName(schemaNode.getQName())), schemaNode);
        if (parent == null) {
    ...
    private GeneratedTypeBuilder addRawInterfaceDefinition(final ModuleContext context, final SchemaNode schemaNode) {
        return addRawInterfaceDefinition(context, schemaNode, "");
    }
    ...
    private GeneratedTypeBuilder addRawInterfaceDefinition(final ModuleContext context, final SchemaNode schemaNode,
        ...
        return addRawInterfaceDefinition(
            TypeName.create(packageNameForGeneratedType(context.modulePackageName(), schemaNode.getPath()),
     ...
     *
     */
    private GeneratedTypeBuilder addRawInterfaceDefinition(final TypeName identifier, final SchemaNode schemaNode) {
    ...
    private GeneratedTOBuilder addTOToTypeBuilder(final TypeDefinition<?> typeDef,
        ...
        if (typeDef instanceof UnionTypeDefinition) {
            ...
            genTOBuilders.add(typeProvider.provideGeneratedTOBuilderForBitsTypeDefinition(
                    packageName, (BitsTypeDefinition) typeDef, classNameFromLeaf, parentModule.getName()));
        }
