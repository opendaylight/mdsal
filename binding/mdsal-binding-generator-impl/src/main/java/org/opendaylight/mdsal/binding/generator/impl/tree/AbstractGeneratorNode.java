...
/**
 * A single node in generator tree. Each node will eventually resolve to a generated Java class.
 */
public abstract class AbstractGeneratorNode<T extends EffectiveStatement<?, ?>> {
    private final @NonNull T statement;

    private JavaTypeName typeName;
    private String assignedName;

    AbstractGeneratorNode(final T statement) {
     ...
     */
    @NonNull YangStatementNamespace namespace() {
        return YangStatementNamespace.DEFAULT;
    }
