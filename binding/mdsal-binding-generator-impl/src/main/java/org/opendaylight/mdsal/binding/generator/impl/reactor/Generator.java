...
public abstract class Generator implements Iterable<Generator> {
    ...
    @NonNull String createJavaPackage() {
        return createJavaPackage(getParent());
    }

    final @NonNull String createJavaPackage(final @NonNull AbstractCompositeGenerator<?> parent) {
        final String parentPackage = parent.javaPackage();
