...
public abstract class Generator implements Iterable<Generator> {
    ...
    public final @NonNull Optional<GeneratedType> getType() {
    ...
    abstract @Nullable Member ensureMember();
    ...
    final @Nullable GeneratedType createType(final TypeBuilderFactory builderFactory) {
        ...
        generatedType = local = producesType() ? Optional.of(createTypeImpl(requireNonNull(builderFactory)))
            : Optional.empty();
    ...
    @NonNull String createJavaPackage() {
        final String parentPackage = getParent().javaPackage();
