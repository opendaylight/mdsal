...
final class CaseGenerator extends AbstractCompositeGenerator<CaseEffectiveStatement> {
    ...
    GeneratedType createTypeImpl(final TypeBuilderFactory builderFactory) {
        ...
        if (parent instanceof ChoiceGenerator) {
            choice = (ChoiceGenerator) parent;
        } else {
            verify(parent instanceof AbstractAugmentGenerator, "Unexpected parent %s", parent);
            choice = ((AbstractAugmentGenerator) parent).targetChoiceGenerator();
        }
