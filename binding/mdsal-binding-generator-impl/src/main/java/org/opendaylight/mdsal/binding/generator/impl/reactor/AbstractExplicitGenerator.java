...
abstract class AbstractExplicitGenerator<T extends EffectiveStatement<?, ?>> extends Generator implements CopyableNode {
    ...
    void addAsGetterMethod(final @NonNull GeneratedTypeBuilder builder,
...
//        }
    ...
    MethodSignatureBuilder constructGetter(final GeneratedTypeBuilder builder, final Type returnType) {
...
//        addComment(getMethod, node);
    ...
    void addAsGetterMethodOverride(final GeneratedTypeBuilder builder, final TypeBuilderFactory builderFactory) {
