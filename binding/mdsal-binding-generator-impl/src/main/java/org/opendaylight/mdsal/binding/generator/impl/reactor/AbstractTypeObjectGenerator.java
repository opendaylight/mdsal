    ...
    final void linkDependencies(final GeneratorContext context) {
        ...
        if (!isBuiltinName(typeName)) {
            ...
            if (prev != null) {
                ...
                // TODO: what is guarding this having been resolved?
                baseGen = verifyNotNull(((AbstractTypeObjectGenerator<?>) prev).baseGen,
                    "Unresolved base generator in previous %s of %s", prev, this);
            } else {
