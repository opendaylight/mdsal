...
abstract class AbstractTypeObjectGenerator<T extends EffectiveStatement<?, ?>> extends AbstractDependentGenerator<T> {
    ...
    ClassPlacement classPlacement() {
        return refType == null ? ClassPlacement.TOP_LEVEL : ClassPlacement.NONE;
    }
    ...
    abstract @NonNull GeneratedType createDerivedType(@NonNull TypeBuilderFactory builderFactory,
        @NonNull GeneratedType baseType);
