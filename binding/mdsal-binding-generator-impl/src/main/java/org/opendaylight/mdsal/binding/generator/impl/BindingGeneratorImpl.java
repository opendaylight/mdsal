...
public class BindingGeneratorImpl implements BindingGenerator {
     ...
     *
     * @param classNameFromLeaf
     *            name of the java class generated from the leaf node
     * @param typeBuilder
     *            generated type builder representing the parent node of the leaf node
     * @param parentModule
     *            parent YANG module
     * @return normalized version of the leaf node name
     */
