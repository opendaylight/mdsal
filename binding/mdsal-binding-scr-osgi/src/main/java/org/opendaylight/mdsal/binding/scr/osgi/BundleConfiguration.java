...
final class BundleConfiguration extends AbstractRegistration {
    ...
    protected void removeRegistration() {
        ...
        // FIXME: this will cause spurious RejectedExecutionExceptions while modules are being shut down, can we provide
        //        an executor, which will just return cancelled futures?
