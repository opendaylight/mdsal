...
public final class BindingRuntimeHelpers {
    ...
    public static QName getQName(final BindingRuntimeContext context, final Class<?> clazz) {
        JavaTypeName javaTypeName = JavaTypeName.create(clazz);
        RuntimeType runtimeType = context.getTypes().findSchema(javaTypeName).orElseThrow(() ->
    ...
    public static QNameModule getQNameModule(final BindingRuntimeContext context, final Class<?> clazz) {
        JavaTypeName javaTypeName = JavaTypeName.create(clazz);
        ModuleRuntimeType qnameModule = context.getTypes().findQNameModule(javaTypeName).orElseThrow(() ->
