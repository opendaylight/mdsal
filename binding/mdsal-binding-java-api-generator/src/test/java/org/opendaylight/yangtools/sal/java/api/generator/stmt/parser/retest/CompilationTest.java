...
import static org.opendaylight.yangtools.sal.java.api.generator.stmt.parser.retest.CompilationTestUtils.NS_TEMP;
...
public class CompilationTest extends BaseCompilationTest {
    ...
    public void testBug5882() throws Exception {
        ...
        final File parent = new File(sourcesOutputDir, NS_TEMP);
