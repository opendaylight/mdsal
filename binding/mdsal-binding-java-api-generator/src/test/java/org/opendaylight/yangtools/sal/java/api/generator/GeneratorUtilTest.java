...
public class GeneratorUtilTest {
    ...
    @Test(expected = IllegalArgumentException.class)
    public void getTopParrentTransportObjectWithExceptionTest() throws Exception {
        GeneratorUtil.getTopParrentTransportObject(null);
    }

    @Test
    public void getTopParrentTransportObjectTest() throws Exception {
        assertEquals(enclosedType, GeneratorUtil.getTopParrentTransportObject(enclosedType));

        final GeneratedTransferObject parent = mock(GeneratedTransferObject.class);
        doReturn(parent).when(enclosedType).getSuperType();
        assertEquals(parent, GeneratorUtil.getTopParrentTransportObject(enclosedType));
    }
}