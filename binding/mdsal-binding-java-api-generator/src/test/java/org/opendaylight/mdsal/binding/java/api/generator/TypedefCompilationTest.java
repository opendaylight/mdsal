...
public class TypedefCompilationTest extends BaseCompilationTest {
    ...
    public void test() throws Exception {
        ...
        Field validBitsConstant = CompilationTestUtils.assertContainsField(bitsExtClass, "VALID_BITS",
                ImmutableSet.class);
        System.out.println("validBitsConstant = " + validBitsConstant.getType());
        ...
        CompilationTestUtils.assertContainsFieldWithValue(bitsExtClassRestricted, "VALID_BITS", ImmutableSet.class,
                ImmutableSet.copyOf(expectedBits), boolean.class, boolean.class, boolean.class, boolean.class,
