...
public class Mdsal827Test extends BaseCompilationTest {
    ...
    public void test() throws Exception {
        ...
        Class<?> foo = Class.forName(BASE_PKG + ".mdsal827.norev.Foo", true, loader);
        Class<?> bar = Class.forName(BASE_PKG + ".mdsal827.norev.Bar", true, loader);
        ...
        Class<?> myType1 = Class.forName(BASE_PKG + ".mdsal827.norev.MyType1", true, loader);
        Class<?> myType2 = Class.forName(BASE_PKG + ".mdsal827.norev.MyType2", true, loader);
        Class<?> myType3 = Class.forName(BASE_PKG + ".mdsal827.norev.MyType3", true, loader);
