...
public class CompilationTest extends BaseCompilationTest {
    ...
    @Test
    public void testMdsal44_2() throws Exception {
        final File sourcesOutputDir = CompilationTestUtils.generatorOutput("mdsal44_2");
        final File compiledOutputDir = CompilationTestUtils.compilerOutput("mdsal44_2");
        List<Type> types = generateTestSources("/compilation/mdsal44_2", sourcesOutputDir);
        CompilationTestUtils.testCompilation(sourcesOutputDir, compiledOutputDir);
        CompilationTestUtils.cleanUp(sourcesOutputDir, compiledOutputDir);
    }
