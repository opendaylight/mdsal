...
public abstract class BaseCompilationTest {
    ...
    protected static final List<GeneratedType> generateTestSources(final String resourceDirPath,
        ...
        final DefaultBindingGenerator defBindingGen = new DefaultBindingGenerator();
        final List<GeneratedType> types = defBindingGen.generateTypes(context);
        final Map<Module, ModuleGenerator> moduleGens = defBindingGen.generateMappingForModuleGenerators(context);
