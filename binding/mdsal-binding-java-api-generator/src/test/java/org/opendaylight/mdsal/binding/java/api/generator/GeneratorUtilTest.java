...
public class GeneratorUtilTest {
    ...
    @Test
    public void isPresenceContainerNegativeTest() {
        assertFalse(GeneratorUtil.isPresenceContainer(generatedType));
    }

    @Test
    public void isPresenceContainerPositiveTest() {
        ...
        assertTrue(GeneratorUtil.isPresenceContainer(generatedType));
    }
}