...
public class SpecializingRelativeLeafrefTypesTest {
    ...
    public void before() throws IOException, URISyntaxException {
        sourcesOutputDir = CompilationTestUtils.generatorOutput("mdsal4226");
        compiledOutputDir = CompilationTestUtils.compilerOutput("mdsal4226");
        types = generateTestSources("/compilation/mdsal426", sourcesOutputDir);
        files = getFiles(sourcesOutputDir);
    }

    @Test
    public void generatedTypeTest() throws IOException, URISyntaxException {
    ...
    public void barContBuilderDataObjectTest() throws IOException {
        ...
        assertTrue(content.contains("public BarContBuilder(org.opendaylight.yang.gen.v1.a.norev.BarGrp arg) {\n"
                + "        this._leaf1 = arg.getLeaf1();\n"
                + "        this._name = arg.getName();\n"
                + "        this._leaf2 = arg.getLeaf2();\n"
                + "    }"));
        // FooGrp leaf1 return type is Object, cast needed
        assertTrue(content.contains("public BarContBuilder(org.opendaylight.yang.gen.v1.a.norev.FooGrp arg) {\n"
        ...
        assertTrue(content.contains("public void fieldsFrom(DataObject arg) {\n"
                ...
                + "        if (arg instanceof org.opendaylight.yang.gen.v1.a.norev.BarGrp) {\n"
                + "            this._name = ((org.opendaylight.yang.gen.v1.a.norev.BarGrp)arg).getName();\n"
                + "            isValidArg = true;\n"
                + "        }\n"
                + "        if (arg instanceof org.opendaylight.yang.gen.v1.a.norev.FooGrp) {\n"
                + "            this._leaf1 = CodeHelpers.checkFieldCast(java.lang.String.class,"
                + " ((org.opendaylight.yang.gen.v1.a.norev.FooGrp)arg).getLeaf1(), \"leaf1\");\n"
                + "            this._leaf2 = ((org.opendaylight.yang.gen.v1.a.norev.FooGrp)arg).getLeaf2();\n"
                + "            isValidArg = true;\n"
                + "        }\n"
                + "        CodeHelpers.validValue(isValidArg, arg, \"[org.opendaylight.yang.gen.v1.a.norev.BarGrp,"
                + " org.opendaylight.yang.gen.v1.a.norev.FooGrp]\");\n"
                + "    }"));
    }
    ...
    public void bazContBuilderDataObjectTest() throws IOException {
        ...
        assertTrue(content.contains("public BazContBuilder(org.opendaylight.yang.gen.v1.a.norev.BazGrp arg) {\n"
                + "        this._leaf1 = arg.getLeaf1();\n"
                + "        this._name = arg.getName();\n"
                + "        this._leaf2 = arg.getLeaf2();\n"
                + "    }"));
        // BarGrp leaf1 doesn't need cast
        assertTrue(content.contains("public BazContBuilder(org.opendaylight.yang.gen.v1.a.norev.BarGrp arg) {\n"
                + "        this._leaf1 = arg.getLeaf1();\n"
                + "        this._name = arg.getName();\n"
                + "        this._leaf2 = arg.getLeaf2();\n"
                + "    }"));
        // FooGrp leaf1 return type is Object, cast needed
        assertTrue(content.contains("public BazContBuilder(org.opendaylight.yang.gen.v1.a.norev.FooGrp arg) {\n"
                + "        this._leaf1 = CodeHelpers.checkFieldCast(java.lang.String.class, arg.getLeaf1(), \"leaf1\");"
                + "\n"
                + "        this._leaf2 = arg.getLeaf2();\n"
                + "    }"));
        ...
        assertTrue(content.contains("public void fieldsFrom(DataObject arg) {\n"
                ...
                + "            isValidArg = true;\n"
                + "        }\n"
                + "        CodeHelpers.validValue(isValidArg, arg, \"[org.opendaylight.yang.gen.v1.a.norev.BazGrp,"
                + " org.opendaylight.yang.gen.v1.a.norev.BarGrp, org.opendaylight.yang.gen.v1.a.norev.FooGrp]\");\n"
                + "    }"));
    }
