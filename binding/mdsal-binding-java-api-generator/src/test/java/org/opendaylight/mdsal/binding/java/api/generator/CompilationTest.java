...
public class CompilationTest extends BaseCompilationTest {
    ...
    public void yangDataCompilation() throws Exception {
        ...
        final List<String> artifactNames = List.of(
            "$YangModuleInfoImpl", "YangDataDemoData",
            "RootContainer", "RootContainerBuilder",
            "YangDataContainer", "YangDataContainerBuilder",
            "YangDataList", "YangDataListBuilder",
            "YangDataAnydata", "YangDataAnyxml",
            "GrpContainer", "GrpList", "GrpLeaf", "GrpLeafList",
            "GrpAnydata", "GrpAnyxml",
            "grp.container.ContainerFromGroup", "grp.container.ContainerFromGroupBuilder",
            "grp.list.ListFromGroup", "grp.list.ListFromGroupBuilder",
            "grp.anydata.AnydataFromGroup", "grp.anyxml.AnyxmlFromGroup");
        ...
        final Class<?> moduleClass = Class.forName(CompilationTestUtils.BASE_PKG
            + ".urn.test.yang.data.demo.rev220222.YangDataDemoData", true, loader);
        ...
        final List<String> expectedMethodNames = List.of(
            ...
            "getYangDataContainer", "nonnullYangDataContainer",
            "getYangDataList", "nonnullYangDataList",
            "getYangDataLeaf", "requireYangDataLeaf",
            "getYangDataLeafList", "requireYangDataLeafList",
            "getYangDataAnydata", "requireYangDataAnydata",
            "getYangDataAnyxml", "requireYangDataAnyxml");
