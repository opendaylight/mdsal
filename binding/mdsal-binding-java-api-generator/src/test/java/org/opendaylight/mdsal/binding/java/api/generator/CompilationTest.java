...
public class CompilationTest extends BaseCompilationTest {
    ...
    public void yangDataCompilation() throws Exception {
        ...
        final List<String> artifactNames = List.of(
                ...
                "$lalaho$20$papluhu", "$lalaho$20$papluhuBuilder", "LatinNaming", "LatinNamingBuilder",
                "$$43F$$440$$438$$432$$435$$442$", "$$43F$$440$$438$$432$$435$$442$Builder",
                "CyrillicNaming", "CyrillicNamingBuilder"
        );
