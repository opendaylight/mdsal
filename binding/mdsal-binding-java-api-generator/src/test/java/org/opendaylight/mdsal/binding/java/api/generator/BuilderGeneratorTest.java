...
public class BuilderGeneratorTest {
    ...
    public void builderTemplateGenerateToEqualsComparingOrderTest() {
        ...
        final ImmutableSortedSet.Builder<BuilderGeneratedProperty> propertyBuilder =
                ImmutableSortedSet.orderedBy(ByTypeMemberComparator.getInstance());
        final List<String> sortedProperties = propertyBuilder.addAll(bt.properties).build()
                .stream().map(BuilderGeneratedProperty::getName).collect(Collectors.toList());

        assertEquals(List.of(
                // numeric types (boolean, byte, short, int, long, biginteger, bigdecimal), identityrefs
                "id16", "id16Def", "id32", "id32Def", "id64", "id64Def", "id8", "id8Def", "idBoolean",
                "idBooleanDef", "idDecimal64", "idDecimal64Def", "idIdentityref", "idIdentityrefDef", "idLeafref",
                "idLeafrefDef", "idU16", "idU16Def", "idU32", "idU32Def", "idU64", "idU64Def", "idU8", "idU8Def",
                // string, binary, bits
                ...
                // other types
                "idContainer1", "idContainer2", "idEmpty", "idEmptyDef", "idEnumeration", "idEnumerationDef",
