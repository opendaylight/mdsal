...
class YangModuleInfoTemplate {
    ...
    val Function<Module, Optional<Collection<String>>> moduleFilePathResolver
    ...
    new(Module module, SchemaContext ctx, Function<Module, Optional<Collection<String>>> moduleFilePathResolver) {
