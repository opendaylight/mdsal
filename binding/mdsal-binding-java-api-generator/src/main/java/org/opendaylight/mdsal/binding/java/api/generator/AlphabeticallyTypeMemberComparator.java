...
/**
 * Alphabetically type member {@link Comparator} which provides sorting primary by name and secondary by name of
 * return type for type members (variables and methods)
