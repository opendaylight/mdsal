    ...
    def String generate() {
        ...
        val body = '''
            ...
            public final class «MODULE_INFO_CLASS_NAME» extends ResourceYangModuleInfo {
                ...
                private static final @NonNull QName NAME = QName.create("«module.QNameModule.getNamespace.toString»", «IF rev.present»"«rev.orElseThrow.toString»", «ENDIF»"«module.name»").intern();
    ...
    private def generateSubInfo(Set<Submodule> submodules) '''
        «FOR submodule : submodules»
            ...
            private static final class «className»Info extends ResourceYangModuleInfo {
                ...
                private final @NonNull QName NAME = QName.create("«submodule.QNameModule.getNamespace.toString»", «
