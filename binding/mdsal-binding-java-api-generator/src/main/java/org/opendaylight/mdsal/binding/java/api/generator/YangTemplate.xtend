...
import org.opendaylight.mdsal.binding.generator.impl.BindingGeneratorImpl.VerboseCommentGenerator
...
final class YangTemplate extends VerboseCommentGenerator {
