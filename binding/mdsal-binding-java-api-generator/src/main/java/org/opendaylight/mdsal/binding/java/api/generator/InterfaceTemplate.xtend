...
class InterfaceTemplate extends BaseTemplate {
    ...
    def generateBindingToString() '''
         ...
         *
         «IF augmentable»
         * <p>
         * @param <T$$> implementation type, which has to also implement «AugmentationHolder.importedName» interface
         *              contract.
         «ENDIF»
         * @param obj Object for which to generate toString() result.
         * @return {@link «STRING.importedName»} value of data modeled by this interface.
         * @throws {@link «NPE.importedName» if {@code obj} is null
         */
        «IF augmentable»
            static <T$$ extends «type.fullyQualifiedName» & «AugmentationHolder.importedName»<«type.fullyQualifiedName»>> «STRING.importedName» «BINDING_TO_STRING_NAME»(final @«NONNULL.importedName» T$$ obj) {
        «ELSE»
