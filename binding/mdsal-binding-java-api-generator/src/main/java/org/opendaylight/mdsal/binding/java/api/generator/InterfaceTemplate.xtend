...
class InterfaceTemplate extends BaseTemplate {
    ...
    def generateBindingToString() '''
         ...
         */
        «IF augmentable»
            static <T$$ extends «type.importedName» & «AugmentationHolder.importedName»<«type.importedName»>> «STRING.importedName» «BINDING_TO_STRING_NAME»(final @«NONNULL.importedName» T$$ obj) {
        «ELSE»
