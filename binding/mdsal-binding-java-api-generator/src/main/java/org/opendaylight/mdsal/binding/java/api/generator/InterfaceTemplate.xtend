...
class InterfaceTemplate extends BaseTemplate {
    ...
    def generateBindingToString() '''
        ...
        «val importedType = type.importedName»
        /**
         ...
         */
        «IF augmentable»
            static <T$$ extends «importedType» & «AugmentationHolder.importedName»<«importedType»>> «STRING.importedName» «BINDING_TO_STRING_NAME»(final @«NONNULL.importedName» T$$ obj) {
        «ELSE»
