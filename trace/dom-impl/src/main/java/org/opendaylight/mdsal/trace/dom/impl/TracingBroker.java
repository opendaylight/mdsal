 ...
 */
package org.opendaylight.mdsal.trace.dom.impl;
 ...
 * </li>
 * <li>
 * Then just load the odl-mdsaltrace feature before your feature and you're done.
 * </li>
 * </ol>
 ...
 *        watchRegistrations and allow all registrations to be printed.
 *     </li>
 * </ul>
 *
 */
public class TracingBroker  implements TracingDOMDataBroker {
    ...
    private DOMDataBroker delegate;
    ...
    public Map<Class<? extends DOMDataBrokerExtension>, DOMDataBrokerExtension> getSupportedExtensions() {
        ...
        res.put(DOMDataTreeChangeService.class, new DOMDataTreeChangeService() {
            ...
            public <L extends DOMDataTreeChangeListener> ListenerRegistration<L> registerDataTreeChangeListener(
                    @Nonnull DOMDataTreeIdentifier domDataTreeIdentifier, @Nonnull L l) {
                if (isRegistrationWatched(domDataTreeIdentifier.getRootIdentifier(),
                    ...
                    LOG.warn("Registration (registerDataTreeChangeListener) for {} from {}",
                            toPathString(domDataTreeIdentifier.getRootIdentifier()), getStackSummary(1));
                }
                return treeChangeSvc.registerDataTreeChangeListener(domDataTreeIdentifier, l);
            }
        });
    ...
    private class Watch {
        ...
        public boolean subtreesOverlap(YangInstanceIdentifier iid, LogicalDatastoreType store, DataChangeScope scope) {
     ...
     * @param delegate The real DataBroker
     */
    public TracingBroker(DOMDataBroker delegate) {
        this.delegate = delegate;
    }
    ...
    private boolean isRegistrationWatched(YangInstanceIdentifier iid, LogicalDatastoreType store, DataChangeScope scope) {
    ...
    public ListenerRegistration<DOMDataChangeListener> registerDataChangeListener(
        ...
        if (isRegistrationWatched(yangInstanceIdentifier, logicalDatastoreType, dataChangeScope)) {
            LOG.warn("Registration (registerDataChangeListener) for {} from {}",
                    toPathString(yangInstanceIdentifier), getStackSummary(1));
        }
        return delegate.registerDataChangeListener(logicalDatastoreType, yangInstanceIdentifier,
                                                                        domDataChangeListener, dataChangeScope);
    }
