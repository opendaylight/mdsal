...
final class ClusterSingletonServiceGroupImpl<P extends Path<P>, E extends GenericEntity<P>,
    ...
    // TODO : it needs to rewrite to classic StateMachine (INITIALIZED, TRY_TO_TAKE_LEADERSHIP, LEADER, FOLLOWER, TERMINATED)
            ...
            if (hasOwnership) {
                ...
                Futures.addCallback(closeService, new FutureCallback<Void>() {
                    ...
                    public void onFailure(final Throwable t) {
                        LOG.info("Close Service {} fail.", service.getIdentifier().getValue(), t);
                        removeServiceFromGroup(service);
                    }
                });
            } else {
