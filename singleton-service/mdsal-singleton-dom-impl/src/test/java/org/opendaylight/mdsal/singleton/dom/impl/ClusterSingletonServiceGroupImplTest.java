...
public class ClusterSingletonServiceGroupImplTest {
    ...
    public void inJeopardyLeaderClusterSingletonServiceGroupTest() throws CandidateAlreadyRegisteredException {
        ...
        singletonServiceGroup.ownershipChanged(getEntityToOwnedJeopardy());
        verify(mockClusterSingletonService, never()).closeServiceInstance();
    ...
    /**
     * Check if the group rejects registration when it was not initialized.
     */
    @Test(expected = IllegalStateException.class)
    public void registerServiceNotInitializedGroupTest() {
        singletonServiceGroup.registerService(firstReg);
    }
    ...
    private static GenericEntityOwnershipChange<TestInstanceIdentifier, TestEntity> getEntityToOwnedJeopardy() {
        return new GenericEntityOwnershipChange<>(MAIN_ENTITY,
