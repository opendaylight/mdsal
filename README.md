...
- Defines a _common-layer, concepts, data model building blocks and messaging
  patterns_ and provides infrastructure / framework for applications and
...
The MD-SAL uses _YANG_ as the modeling language for both interface and data
...
NOTE: Model-driven nature of the MD-SAL and _DOM_-based APIs allows for
...
For example _RESTCONF Connector_ is an application built on top of MD-SAL
